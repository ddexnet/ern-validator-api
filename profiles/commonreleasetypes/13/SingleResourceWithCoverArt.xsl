...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Schematron Release Profile for Single Resource With Cover Art (version 1.3.1) for the NewReleaseMessage."
                              schemaVersion="">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Release Profile for Single Resource With Cover Art (version 1.3.1) for the NewReleaseMessage.</svrl:text>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M6">
      ...
      <xsl:if test="MidiDetailsByTerritory/RemasteredDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Information: #Single Resource With Cover Art) No deprecated date elements should be used.</svrl:text>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Information: #Single Resource With Cover Art) The MessageSchemaVersionId should be at least 3.7.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Information: #Single Resource With Cover Art) You are not using the latest XSD supported by this Schematron file.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M7"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup"
      ...
      <xsl:if test="ResourceGroup">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceGroup">
            ...
            <svrl:text>Information: #Single Resource With Cover Art) There should not be more than 5 nested ResourceGroups.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M8"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList/SoundRecording"
      ...
      <xsl:if test="IsHiddenResource">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="IsHiddenResource">
            ...
            <svrl:text>Information: #Single Resource With Cover Art) No deprecated Flags (IsHiddenResource) must be provided for SoundRecordings.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="IsBonusResource">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="IsBonusResource">
            ...
            <svrl:text>Information: #Single Resource With Cover Art) No deprecated Flags (IsBonusResource) must be provided for SoundRecordings.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M9"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) One component release should be supplied per primary resource referenced on the Main release, regardless of whether there are any deals available for the component release (Release Profile 1.3.1, Clause 3.1, Rule 2038-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M10"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList" priority="1000" mode="M11">
      ...
      <xsl:if test="count(Release[@IsMainRelease = 'true']) &lt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) At least one Release shall have IsMainRelease flag = True (Release Profile 1.3.1, Clause 3.3.1(1), Rule 2039-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="count(Release[@IsMainRelease = 'true']) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) More than one Release with IsMainRelease has been specified (Release Profile 1.3.1, Clause 3.3.1(1), Rule 2039-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M11"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) Track bundle resource groups should be sequenced (Release Profile 1.3.1, Clause 3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 2040-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M12"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) All ResourceGroups should be sequenced (Release Profile 1.3.1, Clause 3.3.1(2), Rule 2041-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M13"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release[@IsMainRelease = 'true']/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroup"
      ...
      <xsl:if test="descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber &gt; '1'] and not(descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber = '1'])">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) All Primary Resources should be sequenced in the context of their track bundle ResourceGroup (i.e. the sequence restarts with the next track bundle) (Release Profile 1.3.1, Clause 3.3.1(3), Rule 2042-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M14"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) All ResourceGroupContentItems should be sequenced (Release Profile 1.3.1, Clause 3.3.1(3), Rule 2043-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M15"/>
   ...
   <xsl:template match="//ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]"
      ...
      <xsl:if test="SequenceNumber">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
            ...
            <svrl:text>Error: #Single Resource With Cover Art) Secondary Resources (e.g. cover images) content items shall not be sequenced (Release Profile 1.3.1, Clause 3.3.1(4), Rule 2044-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M16"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Fatal Error: #Single Resource With Cover Art) Primary SoundRecording Resources shall have an IndirectSoundRecordingId (Release Profile 1.3.1, Clause 3.3.1(6), Rule 2045-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M17"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@ReleaseResourceType">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) For each ReleaseResourceReference a ReleaseResourceType shall be provided (Release Profile 1.3.1, Clause 4.3(1)+4.3(2), Rule 2046-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M18"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(*) &gt; 0">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A ResourceList must contain at least one Resource (Release Profile 1.3.1, Clause 4.3(3), Rule 2047-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M19"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A Single ReferenceTitle must be provided for each SoundRecording (Release Profile 1.3.1, Clause 4.3(4), Rule 2048-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M20"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) At least one Title of type FormalTitle shall be provided for the default Worldwide ReleaseDetailsByTerritory section (Release Profile 1.3.1, Clause 4.3(4), Rule 2049-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M21"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) At least one Title of type DisplayTitle shall be provided for the default Worldwide ReleaseDetailsByTerritory section (Release Profile 1.3.1, Clause 4.3(4), Rule 2050-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M22"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="PLine">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A PLine shall be provided either in the first ReleaseDetailsByTerritory or in all other ReleaseDetailsByTerritory composites (Release Profile 1.3.1, Clause 4.3(5a), Rule 2051-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M23"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="CLine">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A CLine shall be provided either in the first ReleaseDetailsByTerritory or in all other ReleaseDetailsByTerritory composites (Release Profile 1.3.1, Clause 4.3(5b), Rule 2052-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M24"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Single Resource With Cover Art) If more than one LabelName is provided, exactly one shall be a DisplayLabelName (Release Profile 1.3.1, Clause 4.3(6), Rule 2053-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M25"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory[position() = 1 and not(LabelName[string-length(normalize-space(text())) &gt; 0])] and ReleaseDetailsByTerritory[position() &gt; 1 and not(LabelName[string-length(normalize-space(text())) &gt; 0])]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: #Single Resource With Cover Art) If a LabelName is not specified for the Worldwide ReleaseDetailsByTerritory, it needs to be specified in all the other ReleaseDetailsByTerritory composites (Release Profile 1.3.1, Clause 4.3(6a)+4.3(6b), Rule 2054-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M26"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Single Resource With Cover Art) The LabelNameType shall be 'UserDefined' if a user-defined value is supplied for a LabelName (Release Profile 1.3.1, Clause 4.3(6b), Rule 2055-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@Namespace">
               ...
               <svrl:text>Error: #Single Resource With Cover Art) The appropriate Namespace for the user-defined value shall be provided (Release Profile 1.3.1, Clause 4.3(6b), Rule 2055-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M27"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory[position = 1 and not(Genre/GenreText[string-length(normalize-space(text())) &gt; 0])] and ReleaseDetailsByTerritory[position() &gt; 1 and not(Genre/GenreText[string-length(normalize-space(text())) &gt; 0])]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) If a Genre is not specified for the Worldwide ReleaseDetailsByTerritory, it needs to be specified in all the other ReleaseDetailsByTerritory composites. (Release Profile 1.3.1, Clause 4.3(7), Rule 2056-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M28"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Single Resource With Cover Art) The appropriate ParentalWarningType shall be provided (Release Profile 1.3.1, Clause 4.3(8), Rule 2057-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M29"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Single Resource With Cover Art) A GlobalReleaseDate or a ReleaseDate shall be provided for each Release (Release Profile 1.3.1, Clause 4.3(9), Rule 2058-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M30"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Single Resource With Cover Art) A ResourceReleaseDate or an OriginalResourceReleaseDate shall be provided for each primary Resource if available to the Message Sender (Release Profile 1.3.1, Clause 4.3(10), Rule 2059-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M31"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Single Resource With Cover Art) If there is a MusicalWork, there has to be a creative contributor (Release Profile 1.3.1, Clause 4.3(12a), Rule 2060-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M32"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Error: #Single Resource With Cover Art) No MusicalWorkContributor was found; information of at least one MusicalWorkContributor should be provided if available (Release Profile 1.3.1, Clause 4.3(12a), Rule 2061-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M33"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) ResourceContributors shall be provided only once (with multiple roles) (Release Profile 1.3.1, Clause 4.3(13)+4.3(20), Rule 2062-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M34"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ResourceList" priority="1000" mode="M35">
      ...
      <xsl:if test="*/*/DisplayArtistName">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="*/*/DisplayArtistName">
            ...
            <svrl:text>Error: #Single Resource With Cover Art) The DisplayArtistNames of a Resource shall not be the same as the DisplayArtistName of the Album it belongs to (Release Profile 1.3.1, Clause 4.3(18), Rule 2063-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M35"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Conditional Fatal Error: #Single Resource With Cover Art) IndirectResourceContributors shall be provided only once (with multiple roles) (Release Profile 1.3.1, Clause 4.3(21), Rule 2064-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M36"/>
   ...
   <xsl:template match="//MusicalWork" priority="1000" mode="M37">
      ...
      <xsl:if test="sum(//RightShare/RightSharePercentage) &gt; 100">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) The total of all RightSharePercentages for each MusicalWork must not exceed 100% (Release Profile 1.3.1, Clause 4.3(22), Rule 2065-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M37"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A RightSharePercentage has a value between 0 and 100 (Release Profile 1.3.1, Clause 4.3(22), Rule 2066-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M38"/>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M39">
      ...
      <xsl:if test="CatalogTransfer">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="CatalogTransfer">
            ...
            <svrl:text>Conditional Fatal Error: #Single Resource With Cover Art) The CatalogTransfer element has been used. This is only to be used when communicating a catalogue transfer (Release Profile 1.3.1, Clause 4.3(23), Rule 2067-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M39"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M40">
      ...
      <xsl:if test="SoundRecording/IsHiddenResource | MIDI/IsHiddenResource | Video/IsHiddenResource">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) IsHiddenResource must not be used on a Resource (Release Profile 1.3.1, Clause 4.3(24)+4.10(7g)+4.10(7h), Rule 2068-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="SoundRecording/IsBonusResource | MIDI/IsBonusResource | Video/IsBonusResource">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) IsBonusResource must not be used on a Resource (Release Profile 1.3.1, Clause 4.3(24)+4.10(7g)+4.10(7h), Rule 2068-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M40"/>
   </xsl:template>
   ...
   <xsl:template match="//TerritoryCode | //ExcludedTerritoryCode"
      ...
      <xsl:if test="(substring(@IdentifierType, 1, 3) = 'ISO' or not(@IdentifierType)) and string-length(normalize-space(text())) != 2 and text() != 'Worldwide' and translate(text(), 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', '') != ''">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) A TerritoryCode of type 'ISO' must be a two-letter code or 'Worldwide' (Release Profile 1.3.1, Clause 4.3(25), Rule 2069-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS' and number() != .">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) A TerritoryCode of type 'TIS' must be a numeric code (Release Profile 1.3.1, Clause 4.3(25), Rule 2069-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) A deprecated TerritoryCode must be a four-letter code (Release Profile 1.3.1, Clause 4.3(25), Rule 2069-3).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M41"/>
   </xsl:template>
   ...
   <xsl:template match="//TerritoryCode | //ExcludedTerritoryCode"
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS'">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) A TerritoryCode of type 'TIS' must not be used (Release Profile 1.3.1, Clause 4.3(25), Rule 2070-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M42"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A PartyId of type 'ISNI' must be a string conforming to the pattern [0-9]{15}[X0-9] (Release Profile 1.3.1, Clause 4.3(30), Rule 2071-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M43"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) An ISRC must be a string conforming to the pattern [a-zA-Z]{2}[a-zA-Z0-9]{3}[0-9]{7} (Release Profile 1.3.1, Clause 4.3(30), Rule 2072-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) An ISRC must be a string starting with an ISO 3166 code or FX, QM, UK, CP, DG or ZZ (Release Profile 1.3.1, Clause 4.3(30), Rule 2072-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M44"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A GRid must be a string conforming to the pattern [a-zA-Z0-9]{18} (Release Profile 1.3.1, Clause 4.3(30), Rule 2073-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M45"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A SICI must be a string conforming to the pattern [0-9]{4}-[0-9]{3}[X0-9].+ (Release Profile 1.3.1, Clause 4.3(30), Rule 2074-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M46"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) An ISSN must be a string conforming to the pattern [0-9]{4}-[0-9]{3}[X0-9] (Release Profile 1.3.1, Clause 4.3(30), Rule 2075-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M47"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) An ISBN must be a string conforming to the pattern 97[8-9][0-9]{9}[X0-9] (Release Profile 1.3.1, Clause 4.3(30), Rule 2076-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M48"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A VISAN must be a string conforming to the pattern [A-F0-9]{24} (Release Profile 1.3.1, Clause 4.3(30), Rule 2077-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M49"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) An ISAN must be a string conforming to the pattern [A-F0-9]{12} (Release Profile 1.3.1, Clause 4.3(30), Rule 2078-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M50"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) An ISMN must be a string conforming to the pattern 979[0-9]{9}[X0-9] (Release Profile 1.3.1, Clause 4.3(30), Rule 2079-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M51"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) An ISWC must be a string conforming to the pattern [a-zA-Z][0-9]{10} (Release Profile 1.3.1, Clause 4.3(30), Rule 2080-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M52"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) An ICPN must be a string conforming to the pattern [0-9]{8} or [0-9]{12,14} (Release Profile 1.3.1, Clause 4.3(30), Rule 2081-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M53"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=".='UserDefined'">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) The value shall be 'UserDefined' if a user-defined value is supplied (Release Profile 1.3.1, Clause 4.3(31), Rule 2082-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@Namespace">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) The appropriate Namespace for the user-defined value shall be provided (Release Profile 1.3.1, Clause 4.3(31), Rule 2082-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M54"/>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M55">
      ...
      <xsl:if test="//Comment">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
            ...
            <svrl:text>Error: #Single Resource With Cover Art) No Comment shall be provided (Release Profile 1.3.1, Clause 4.3(32), Rule 2083-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M55"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@SequenceNumber">
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) All DisplayArtists should be sequenced (Release Profile 1.3.1, Clause 4.3(34), Rule 2084-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M56"/>
   ...
   <xsl:template match="//SequenceNumber" priority="1000" mode="M57">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) SequenceNumbers must run from 1 to the number of sequenced elements (Release Profile 1.3.1, Clause 4.3(35), Rule 2085-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:if test="count(../../*[name(.)=name(current()/..) and SequenceNumber=current()]) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) SequenceNumbers must all be different (Release Profile 1.3.1, Clause 4.3(35), Rule 2085-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M57"/>
   </xsl:template>
   ...
   <xsl:template match="//*[@SequenceNumber]" priority="1000" mode="M58">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) SequenceNumbers must run from 1 to the number of sequenced elements (Release Profile 1.3.1, Clause 4.3(35), Rule 2086-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:if test="@SequenceNumber=following-sibling::*[name()=name(current())]/@SequenceNumber">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) SequenceNumbers must all be different (Release Profile 1.3.1, Clause 4.3(35), Rule 2086-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M58"/>
   </xsl:template>
   ...
   <xsl:template match="//*[@HasMaxValueOfOne = 'true']" priority="1000" mode="M59">
      ...
      <xsl:if test="number(.) &gt; 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &gt; 1">
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) A Percentage with HasMaxValueOfOne set to true has a value between 0 and 1 (Release Profile 1.3.1, Clause 4.3(36a), Rule 2087-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M59"/>
   </xsl:template>
   ...
   <xsl:template match="//*[@HasMaxValueOfOne = 'false']" priority="1000" mode="M60">
      ...
      <xsl:if test="number(.) &lt;= 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &lt;= 1">
            ...
            <svrl:text>Information: #Single Resource With Cover Art) Percentages are typically provided in the interval between 0 and 100. The value provided seems to indicate a value equal to, or less than, 1% (Release Profile 1.3.1, Clause 4.3(36b), Rule 2088-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M60"/>
   </xsl:template>
   ...
   <xsl:template match="//RightSharePercentage[not(@HasMaxValueOfOne)]"
      ...
      <xsl:if test="number(.) &lt;= 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &lt;= 1">
            ...
            <svrl:text>Information: #Single Resource With Cover Art) Percentages are typically provided in the interval between 0 and 100. The value provided seems to indicate a value equal to, or less than, 1% (Release Profile 1.3.1, Clause 4.3(36b), Rule 2089-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M61"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M62">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*:NewReleaseMessage"/>
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="@ReleaseProfileVersionId = 'CommonReleaseTypes/131/SingleResourceReleaseWithCoverArt'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@ReleaseProfileVersionId = 'CommonReleaseTypes/131/SingleResourceReleaseWithCoverArt'">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: #Single Resource With Cover Art) The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/SingleResourceReleaseWithCoverArt' (Release Profile 1.3.1, Clause 3.2, Rule 2090-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M62"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Error: #Single Resource With Cover Art) Primary Video Resources should be identified with an ISRC (Release Profile 1.3.1, Clause 3.1, Rule 2091-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M63"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A Single Resource Release must contain one (and only one) Resource (Release Profile 1.3.1, Clause 3.1, Rule 2092-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M64"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A Single Resource Release must contain one SingleResourceRelease release (Release Profile 1.3.1, Clause 3.1, Rule 2093-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M65"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A Single Resource Release must not contain any Secondary Resources (Release Profile 1.3.1, Clause 3.1, Rule 2094-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M66"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) At least one DisplayArtist shall be provided (Release Profile 1.3.1, Clause 4.3(12c)+4.3(15b), Rule 2095-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M67"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ReleaseDetailsByTerritory/DisplayArtistName = ReleaseResourceReferenceList/descendant::DisplayArtistName">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: #Single Resource With Cover Art) DisplayArtistNames for Release and Resource must be different (Release Profile 1.3.1, Clause 4.3(16a), Rule 2096-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M68"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A Single Resource Release must not contain a release resource structure (Release Profile 1.3.1, Clause 4, Rule 2097-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M69"/>
   ...
   <xsl:template match="*:NewReleaseMessage/ReleaseList/Release"
      ...
      <xsl:if test="ResourceGroup">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceGroup">
            ...
            <svrl:text>Fatal Error: #Single Resource With Cover Art) A Single Resource Release must not contain any Resource Group (Release Profile 1.3.1, Clause 4.12(7), Rule 2098-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M70"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) The MainRelease shall be identified by either a GRid or by an ICPN (Release Profile 1.3.1, Clause 4.18(4), Rule 2099-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M71"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) Primary SoundRecording Resources shall be identified with an ISRC (Release Profile 1.3.1, Clause 4.18(5), Rule 2100-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M72"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: #Single Resource With Cover Art) A LabelName has to be specified for each Release (Release Profile 1.3.1, Clause 4.18(8), Rule 2101-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M73"/>
