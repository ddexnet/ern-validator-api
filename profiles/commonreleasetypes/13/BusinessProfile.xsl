...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Schematron Business Profile for  (version 1.3.1) for the NewReleaseMessage."
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:text>Failing a rule a rule with a role of 'Error' means that the Conformance Tester must recommend to award a Partial Conformance Certificate or to downgrade a Conformance Certificate that has already been issued. However, if more than 40 rules (representing 50% of all rules with a role of 'Error' or 'Conditional Error') have been failed at least once, the Conformance Tester must recommend to not award a Conformance Certificate or to retract a Conformance Certificate if one has already been issued. Failing a rule with a role of 'Conditional Error' is the same as an 'Error', however, the rule may be ignored if the Conformance Tester has  no means of asserting whether the condition expressed in the rule has been met.</svrl:text>
         <svrl:text>The following Clauses from the Business Profile standard are NOT checked by this ISO Schematron file: 4.2(1), 4.2(4)-(5), 4.3.1, 4.3.2(11), 4.4, 4.5, 4.6(1)-(2), (4), 4.7.1(1)-(2), (5), 4.7.3, 4.7.4(1a), (1b), (2a), (2b), 4.7.5, 4.7.6, 4.7.7 and 4.8.</svrl:text>
         <svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Business Profile for  (version 1.3.1) for the NewReleaseMessage.</svrl:text>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms"
      ...
      <xsl:if test="translate(ReleaseDisplayStartDate,'-','') &gt; translate(substring(ValidityPeriod/StartDate,1,10),'-','') or translate(ReleaseDisplayStartDate,'-','') &gt; translate(substring(ValidityPeriod/StartDateTime,1,10),'-','')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: A ReleaseDisplayStartDate may not be later than the StartDate of the Deal.</svrl:text>
      ...
      <xsl:if test="TrackListingPreviewStartDate &gt; ../../EffectiveDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: A TrackListingPreviewStartDate may not be later than the StartDate of the Deal.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="ClipPreviewStartDate &gt; ../../EffectiveDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: A ClipPreviewStartDate may not be later than the StartDate of the Deal.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="CoverArtPreviewStartDate &gt; ../../EffectiveDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: A CoverArtPreviewStartDate may not be later than the StartDate of the Deal.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M6"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*:NewReleaseMessage"/>
		    ...
		    <!--REPORT Information-->
      <xsl:if test="some $x in tokenize(@BusinessProfileVersionId, '\s+') satisfies not(contains('CommonDealTypes/131/GenericDownloadService CommonDealTypes/131/DRMProtectedDownloadService CommonDealTypes/131/NonProtectedDownloadService CommonDealTypes/131/AdSupportedDownloadService CommonDealTypes/131/DRMProtectedAdSupportedDownloadService CommonDealTypes/131/NonProtectedAdSupportedDownloadService CommonDealTypes/131/TetheredDownloadService CommonDealTypes/131/AdSupportedTetheredDownloadService CommonDealTypes/131/InteractiveSubscriptionStreamingService CommonDealTypes/131/InteractiveAdSupportedStreamingService CommonDealTypes/131/NonInteractiveSubscriptionStreamingService CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice CommonDealTypes/131/NonInteractiveAdSupportedStreamingService CommonDealTypes/131/KioskService CommonDealTypes/131/RingtonesAndMobileService CommonDealTypes/131/RightsClaimsOnUserGeneratedContent CommonDealTypes/131/PurchaseAsPhysicalProduct CommonDealTypes/131/GenericAdSupportedStreamingService CommonDealTypes/131/GenericSubscriptionStreamingService  CommonDealTypes/131/GenericPayAsYouGoStreamingService',$x))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Information: The BusinessProfileVersionId should only contain values specified in the standard (Business Profile 1.3.1, Clause 4.1, Rule 2260-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M7"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Information: The MessageSchemaVersionId should be at least 3.7 (Business Profile 1.3.1, Clause 4.1, Rule 2261-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT Information-->
      <xsl:choose>
         <xsl:when test="@MessageSchemaVersionId = 'ern/371'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@MessageSchemaVersionId = 'ern/371'">
               <xsl:attribute name="role">Information</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Information: You are not using the latest XSD supported by this Schematron file (Business Profile 1.3.1, Clause 4.1, Rule 2261-2).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M8"/>
   ...
   <xsl:template match="//TerritoryCode | //ExcludedTerritoryCode"
      ...
      <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS'">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: A TerritoryCode of type 'TIS' must not be used (Business Profile 1.3.1, Clause 4.2(2), Rule 2262-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M9"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/MessageHeader"
      ...
      <xsl:if test="//Comment">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
            ...
            <svrl:text>Fatal Error: No Comment shall be provided in the MessageHeader (Business Profile 1.3.1, Clause 4.2(3), Rule 2263-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M10"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal"
      ...
      <xsl:if test="descendant::*/@LanguageAndScriptCode">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The use of LanguageAndScriptCode is discouraged (Business Profile 1.3.1, Clause 4.3.2(1), Rule 2264-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M11"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M12">
      ...
      <xsl:if test="CatalogTransfer">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="CatalogTransfer">
            ...
            <svrl:text>Conditional Fatal Error: The use of CatalogTransfer is discouraged (Business Profile 1.3.1, Clause 4.3.2(2), Rule 2265-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M12"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms/PriceInformation"
      ...
      <xsl:if test="BulkOrderWholesalePricePerUnit">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of BulkOrderWholesalePricePerUnit is discouraged (Business Profile 1.3.1, Clause 4.3.2(4), Rule 2266-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M13"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms"
      ...
      <xsl:if test="RelatedReleaseOfferSet">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="RelatedReleaseOfferSet">
            ...
            <svrl:text>Fatal Error: The use of RelatedReleaseOfferSet is discouraged (Business Profile 1.3.1, Clause 4.3.2(5), Rule 2267-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M14"/>
   </xsl:template>
   ...
   <!--PATTERN MultiProfile_MustNotContainCarrierType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[not(contains (@BusinessProfileVersionId, 'CommonDealTypes/131/PurchaseAsPhysicalProduct'))]"
                 priority="1000"
                 mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[not(contains (@BusinessProfileVersionId, 'CommonDealTypes/131/PurchaseAsPhysicalProduct'))]"/>
      ...
      <xsl:if test="//CarrierType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//CarrierType">
            ...
            <svrl:text>Fatal Error: The use of CarrierType is discouraged except for PurchaseAsPhysicalProduct (Business Profile 1.3.1, Clause 4.3.2(6), Rule 2268-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M15"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms"
      ...
      <xsl:if test="PhysicalReturns">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="PhysicalReturns">
            ...
            <svrl:text>Fatal Error: The use of PhysicalReturns is discouraged (Business Profile 1.3.1, Clause 4.3.2(7), Rule 2269-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M16"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms"
      ...
      <xsl:if test="NumberOfProductsPerCarton">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The use of NumberOfProductsPerCarton is discouraged (Business Profile 1.3.1, Clause 4.3.2(8), Rule 2270-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M17"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal"
      ...
      <xsl:if test="ResourceUsage">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceUsage">
            ...
            <svrl:text>Fatal Error: The use of ResourceUsage is discouraged (Business Profile 1.3.1, Clause 4.3.2(10), Rule 2271-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M18"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal"
      ...
      <xsl:if test="//Usage[UseType='Stream']/UseType[matches(text(),'.Stream')]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The combination of generic and specific UseTypes is not permitted (Business Profile 1.3.1, Clause 4.3.2(12), Rule 2272-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="//Usage[UseType='Download']/UseType[matches(text(),'.Download')]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The combination of generic and specific UseTypes is not permitted (Business Profile 1.3.1, Clause 4.3.2(12), Rule 2272-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M19"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal"
      ...
      <xsl:if test="//Usage[UseType='InteractiveStream' and UseType='NonInteractiveStream' and UseType='ContentInfluencedStream' and UseType='OnDemandStream' and UseType='TimeInfluencedStream']">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The use of all specific UseTypes is not permitted (Business Profile 1.3.1, Clause 4.3.2(13), Rule 2273-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="//Usage[UseType='ConditionalDownload' and UseType='KioskDownload' and UseType='PermanentDownload' and UseType='TetheredDownload']">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The use of all specific UseTypes is not permitted (Business Profile 1.3.1, Clause 4.3.2(13), Rule 2273-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M20"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M21">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.3(5), Rule 2274-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M21"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M22">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.4(5), Rule 2275-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M22"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M23">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.5(5), Rule 2276-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M23"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M24">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.6(5), Rule 2277-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M24"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M25">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.7(5), Rule 2278-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M25"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M26">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.8(5), Rule 2279-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M26"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M27">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.9(5), Rule 2280-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M27"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M28">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.10(5), Rule 2281-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M28"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M29">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.11(5), Rule 2282-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M29"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M30">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.12(5), Rule 2283-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M30"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M31">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.13(5), Rule 2284-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M31"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M32">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.14(5), Rule 2285-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M32"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M33">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.15(5), Rule 2286-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M33"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M34">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.16(4), Rule 2287-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M34"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M35">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.17(5), Rule 2288-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M35"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M36">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.18(7), Rule 2289-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M36"/>
   </xsl:template>
   ...
   <!--PATTERN PurchaseAsPhysicalProduct_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/PurchaseAsPhysicalProduct')]"
                 priority="1000"
                 mode="M37">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/PurchaseAsPhysicalProduct')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/CommercialModelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: No CommercialModelType should be specified for this Profile (Business Profile 1.3.1, Clause 4.3.19(4), Rule 2290-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M37"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M38">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.19(7), Rule 2291-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M38"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M39">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.20(5), Rule 2292-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M39"/>
   </xsl:template>
   ...
   <!--PATTERN GenericAdSupportedStreamingService_UseType2-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericAdSupportedStreamingService')]"
                 priority="1000"
                 mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericAdSupportedStreamingService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UseType[text() = 'Narrowcast' or text() = 'NonInteractiveStream' or text() = 'OnDemandStream' or text() = 'TimeInfluencedStream' or text() = 'Webcast']">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The UseType should not be a detailed streaming service for this Profile (Business Profile 1.3.1, Clause 4.3.20(8), Rule 2293-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M40"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M41">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.21(5), Rule 2294-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M41"/>
   </xsl:template>
   ...
   <!--PATTERN GenericSubscriptionStreamingService_UseType2-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericSubscriptionStreamingService')]"
                 priority="1000"
                 mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericSubscriptionStreamingService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UseType[text() = 'Narrowcast' or text() = 'NonInteractiveStream' or text() = 'OnDemandStream' or text() = 'TimeInfluencedStream' or text() = 'Webcast']">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The UseType should not be a detailed streaming service for this Profile (Business Profile 1.3.1, Clause 4.3.21(8), Rule 2295-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M42"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M43">
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/ConsumerRentalPeriod">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The ConsumerRentalPeriod should not be used (Business Profile 1.3.1, Clause 4.3.22(5), Rule 2296-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M43"/>
   </xsl:template>
   ...
   <!--PATTERN GenericPayAsYouGoStreamingService_UseType2-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericPayAsYouGoStreamingService')]"
                 priority="1000"
                 mode="M44">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericPayAsYouGoStreamingService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UseType[text() = 'Narrowcast' or text() = 'NonInteractiveStream' or text() = 'OnDemandStream' or text() = 'TimeInfluencedStream' or text() = 'Webcast']">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: The UseType should not be a detailed streaming service for this Profile (Business Profile 1.3.1, Clause 4.3.22(8), Rule 2297-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M44"/>
   </xsl:template>
   ...
   <!--PATTERN InteractiveSubscriptionStreamingService_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')]"
                 priority="1000"
                 mode="M45">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.11(6), Rule 2298-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.11(6), Rule 2298-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M45"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="@ReleaseProfileVersionId = 'CommonReleaseTypes/131/AudioSingle'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@ReleaseProfileVersionId = 'CommonReleaseTypes/131/AudioSingle'">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/AudioSingle' (Business Profile 1.3.1, Clause 4.3.11(7), Rule 2299-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M46"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--REPORT Fatal Error-->
      <xsl:if test="contains(@BusinessProfileVersionId, 'CommonDealTypes/131/Generic')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                 test="contains(@BusinessProfileVersionId, 'CommonDealTypes/131/Generic')">
            <xsl:attribute name="role">Fatal Error</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>Fatal Error: This specific Profile may not be combined with a generic Profile 'CommonDealTypes/131/Generic' (Business Profile 1.3.1, Clause 4.3.11(8), Rule 2300-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M47"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PriceInformation">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PriceInformation is discouraged (Business Profile 1.3.1, Clause 4.3.11(9), Rule 2301-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M48"/>
   </xsl:template>
   ...
   <!--PATTERN InteractiveAdSupportedStreamingService_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveAdSupportedStreamingService')]"
                 priority="1000"
                 mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveAdSupportedStreamingService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.12(6), Rule 2302-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.12(6), Rule 2302-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M49"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/AudioSingle' (Business Profile 1.3.1, Clause 4.3.12(7), Rule 2303-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M50"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveAdSupportedStreamingService')]"
      ...
      <xsl:if test="contains(@BusinessProfileVersionId, 'CommonDealTypes/131/Generic')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: This specific Profile may not be combined with a generic Profile 'CommonDealTypes/131/Generic' (Business Profile 1.3.1, Clause 4.3.12(8), Rule 2304-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M51"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PriceInformation">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PriceInformation is discouraged (Business Profile 1.3.1, Clause 4.3.12(9), Rule 2305-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M52"/>
   </xsl:template>
   ...
   <!--PATTERN NonInteractiveSubscriptionStreamingService_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService')]"
                 priority="1000"
                 mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.13(6), Rule 2306-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.13(6), Rule 2306-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M53"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/AudioSingle' (Business Profile 1.3.1, Clause 4.3.13(7), Rule 2307-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M54"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService')]"
      ...
      <xsl:if test="contains(@BusinessProfileVersionId, 'CommonDealTypes/131/Generic')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: This specific Profile may not be combined with a generic Profile 'CommonDealTypes/131/Generic' (Business Profile 1.3.1, Clause 4.3.13(8), Rule 2308-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M55"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PriceInformation">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PriceInformation is discouraged (Business Profile 1.3.1, Clause 4.3.13(9), Rule 2309-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M56"/>
   </xsl:template>
   ...
   <!--PATTERN NonInteractiveSubscriptionStreamingServiceOnDevice_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice')]"
                 priority="1000"
                 mode="M57">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.14(6), Rule 2310-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.14(6), Rule 2310-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M57"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/AudioSingle' (Business Profile 1.3.1, Clause 4.3.14(7), Rule 2311-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M58"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice')]"
      ...
      <xsl:if test="contains(@BusinessProfileVersionId, 'CommonDealTypes/131/Generic')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: This specific Profile may not be combined with a generic Profile 'CommonDealTypes/131/Generic' (Business Profile 1.3.1, Clause 4.3.14(8), Rule 2312-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M59"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PriceInformation">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PriceInformation is discouraged (Business Profile 1.3.1, Clause 4.3.14(9), Rule 2313-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M60"/>
   </xsl:template>
   ...
   <!--PATTERN NonInteractiveAdSupportedStreamingService_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService')]"
                 priority="1000"
                 mode="M61">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.15(6), Rule 2314-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.15(6), Rule 2314-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M61"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/AudioSingle' (Business Profile 1.3.1, Clause 4.3.15(7), Rule 2315-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M62"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService')]"
      ...
      <xsl:if test="contains(@BusinessProfileVersionId, 'CommonDealTypes/131/Generic')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Fatal Error: This specific Profile may not be combined with a generic Profile 'CommonDealTypes/131/Generic' (Business Profile 1.3.1, Clause 4.3.15(8), Rule 2316-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M63"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PriceInformation">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PriceInformation is discouraged (Business Profile 1.3.1, Clause 4.3.15(9), Rule 2317-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M64"/>
   </xsl:template>
   ...
   <!--PATTERN KioskService_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/KioskService')]"
                 priority="1000"
                 mode="M65">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/KioskService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.16(5), Rule 2318-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.16(5), Rule 2318-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M65"/>
   </xsl:template>
   ...
   <!--PATTERN RingtonesAndMobileService_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RingtonesAndMobileService')]"
                 priority="1000"
                 mode="M66">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RingtonesAndMobileService')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.17(6), Rule 2319-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.17(6), Rule 2319-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M66"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RingtonesAndMobileService')]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="@ReleaseProfileVersionId = 'CommonReleaseTypes/131/Ringtone'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@ReleaseProfileVersionId = 'CommonReleaseTypes/131/Ringtone'">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/Ringtone' (Business Profile 1.3.1, Clause 4.3.17(7), Rule 2320-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M67"/>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms/RightsClaimPolicy"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent' if a RightsClaimPolicy is provided (Business Profile 1.3.1, Clause 4.3.18(3), Rule 2321-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M68"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent' if a WebPolicy is provided (Business Profile 1.3.1, Clause 4.3.18(4), Rule 2322-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M69"/>
   ...
   <!--PATTERN RightsClaimsOnUserGeneratedContent_MustNotContainDates-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent')]"
                 priority="1000"
                 mode="M70">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent')]"/>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.18(8), Rule 2323-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.18(8), Rule 2323-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M70"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//CarrierType">
               ...
               <svrl:text>Fatal Error: A CarrierType shall be specified for this Profile (Business Profile 1.3.1, Clause 4.3.19(3), Rule 2324-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M71"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.20(6), Rule 2325-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.20(6), Rule 2325-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M72"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/AudioSingle' (Business Profile 1.3.1, Clause 4.3.20(7), Rule 2326-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M73"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PriceInformation">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PriceInformation is discouraged (Business Profile 1.3.1, Clause 4.3.20(9), Rule 2327-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M74"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.21(6), Rule 2328-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.21(6), Rule 2328-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M75"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/AudioSingle' (Business Profile 1.3.1, Clause 4.3.21(7), Rule 2329-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M76"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PriceInformation">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PriceInformation is discouraged (Business Profile 1.3.1, Clause 4.3.21(9), Rule 2330-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M77"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericPayAsYouGoStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.22(6), Rule 2331-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business Profile 1.3.1, Clause 4.3.22(6), Rule 2331-2).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M78"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The ReleaseProfileVersionId should be 'CommonReleaseTypes/131/AudioSingle' (Business Profile 1.3.1, Clause 4.3.22(7), Rule 2332-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M79"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericPayAsYouGoStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PriceInformation">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The use of PriceInformation is discouraged (Business Profile 1.3.1, Clause 4.3.22(9), Rule 2333-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M80"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms/PriceInformation[BulkOrderWholesalePricePerUnit] | *:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms/PriceInformation[WholesalePricePerUnit]"
      ...
      <xsl:if test="PriceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="PriceType">
            ...
            <svrl:text>Fatal Error: WholesalePricePerUnit and BulkOrderWholesalePricePerUnit may not be combined with a PriceType (Business Profile 1.3.1, Clause 4.6(3), Rule 2334-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M81"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal"
      ...
      <xsl:if test="EffectiveDate">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EffectiveDate">
            ...
            <svrl:text>Fatal Error: An EffectiveDate must not be specified (Business Profile 1.3.1, Clause 4.7.1(3), Rule 2335-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M82"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms"
      ...
      <xsl:if test="AllDealsCancelled">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="AllDealsCancelled">
            ...
            <svrl:text>Fatal Error: AllDealsCancelled must not be specified (Business Profile 1.3.1, Clause 4.7.1(4)+4.7.4(1c)+4.7.4(2c), Rule 2336-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M83"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage" priority="1000" mode="M84">
      ...
      <xsl:if test="UpdateIndicator">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="UpdateIndicator">
            ...
            <svrl:text>Fatal Error: UpdateIndicator shall not be used (Business Profile 1.3.1, Clause 4.7.2, Rule 2337-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M84"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms"
      ...
      <xsl:if test="TakeDown">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="TakeDown">
            ...
            <svrl:text>Fatal Error: TakeDown must not be specified (Business Profile 1.3.1, Clause 4.7.4(1c)+4.7.4(2c), Rule 2338-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M85"/>
   </xsl:template>
   ...
   <!--PATTERN GenericDownloadService_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericDownloadService')]"
                 priority="1000"
                 mode="M86">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericDownloadService')]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for this Profile (Business Profile 1.3.1, Clause 3(1), Rule 2339-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M86"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile (Business Profile 1.3.1, Clause 3(1), Rule 2340-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M87"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(1), Rule 2341-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M88"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(1), Rule 2342-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M89"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() != 'DrmEnforced']][Usage/TechnicalInstantiation/DrmEnforcementType[text() != 'NotDrmEnforced']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/GenericDownloadService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/GenericDownloadService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/GenericDownloadService' for this combination of categories (Business Profile 1.3.1, Clause 3(1), Rule 2343-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M90"/>
   ...
   <!--PATTERN DRMProtectedDownloadService_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedDownloadService')]"
                 priority="1000"
                 mode="M91">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedDownloadService')]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for this Profile (Business Profile 1.3.1, Clause 3(2), Rule 2344-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M91"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile (Business Profile 1.3.1, Clause 3(2), Rule 2345-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M92"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The DrmEnforcementType should be DrmEnforced for this Profile (Business Profile 1.3.1, Clause 3(2), Rule 2346-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M93"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(2), Rule 2347-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M94"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(2), Rule 2348-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M95"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() = 'DrmEnforced']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedDownloadService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedDownloadService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/DRMProtectedDownloadService' for this combination of categories (Business Profile 1.3.1, Clause 3(2), Rule 2349-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M96"/>
   ...
   <!--PATTERN NonProtectedDownloadService_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedDownloadService')]"
                 priority="1000"
                 mode="M97">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedDownloadService')]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for this Profile (Business Profile 1.3.1, Clause 3(3), Rule 2350-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M97"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile (Business Profile 1.3.1, Clause 3(3), Rule 2351-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M98"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The DrmEnforcementType should be NotDrmEnforced for this Profile (Business Profile 1.3.1, Clause 3(3), Rule 2352-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M99"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(3), Rule 2353-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M100"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(3), Rule 2354-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M101"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() = 'NotDrmEnforced']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedDownloadService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedDownloadService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/NonProtectedDownloadService' for this combination of categories (Business Profile 1.3.1, Clause 3(3), Rule 2355-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M102"/>
   ...
   <!--PATTERN AdSupportedDownloadService_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedDownloadService')]"
                 priority="1000"
                 mode="M103">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedDownloadService')]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be AdvertisementSupportedModel for this Profile (Business Profile 1.3.1, Clause 3(4), Rule 2356-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M103"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile (Business Profile 1.3.1, Clause 3(4), Rule 2357-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M104"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(4), Rule 2358-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M105"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(4), Rule 2359-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M106"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'PermanentDownload']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedDownloadService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedDownloadService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/AdSupportedDownloadService' for this combination of categories (Business Profile 1.3.1, Clause 3(4), Rule 2360-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M107"/>
   ...
   <!--PATTERN DRMProtectedAdSupportedDownloadService_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedAdSupportedDownloadService')]"
                 priority="1000"
                 mode="M108">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedAdSupportedDownloadService')]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be AdvertisementSupportedModel for this Profile (Business Profile 1.3.1, Clause 3(5), Rule 2361-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M108"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile (Business Profile 1.3.1, Clause 3(5), Rule 2362-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M109"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The DrmEnforcementType should be DrmEnforced for this Profile (Business Profile 1.3.1, Clause 3(5), Rule 2363-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M110"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedAdSupportedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(5), Rule 2364-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M111"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedAdSupportedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(5), Rule 2365-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M112"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() = 'DrmEnforced']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedAdSupportedDownloadService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/DRMProtectedAdSupportedDownloadService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/DRMProtectedAdSupportedDownloadService' for this combination of categories (Business Profile 1.3.1, Clause 3(5), Rule 2366-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M113"/>
   ...
   <!--PATTERN NonProtectedAdSupportedDownloadService_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedAdSupportedDownloadService')]"
                 priority="1000"
                 mode="M114">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedAdSupportedDownloadService')]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be AdvertisementSupportedModel for this Profile (Business Profile 1.3.1, Clause 3(6), Rule 2367-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M114"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile (Business Profile 1.3.1, Clause 3(6), Rule 2368-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M115"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The DrmEnforcementType should be NotDrmEnforced for this Profile (Business Profile 1.3.1, Clause 3(6), Rule 2369-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M116"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedAdSupportedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(6), Rule 2370-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M117"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedAdSupportedDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(6), Rule 2371-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M118"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() = 'NotDrmEnforced']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedAdSupportedDownloadService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/NonProtectedAdSupportedDownloadService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/NonProtectedAdSupportedDownloadService' for this combination of categories (Business Profile 1.3.1, Clause 3(6), Rule 2372-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M119"/>
   ...
   <!--PATTERN TetheredDownloadService_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/TetheredDownloadService')]"
                 priority="1000"
                 mode="M120">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/TetheredDownloadService')]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be SubscriptionModel for this Profile (Business Profile 1.3.1, Clause 3(7), Rule 2373-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M120"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be ConditionalDownload for this Profile (Business Profile 1.3.1, Clause 3(7), Rule 2374-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M121"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/TetheredDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(7), Rule 2375-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M122"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/TetheredDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(7), Rule 2376-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M123"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'SubscriptionModel']][Usage/UseType[text() = 'ConditionalDownload']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/TetheredDownloadService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/TetheredDownloadService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/TetheredDownloadService' for this combination of categories (Business Profile 1.3.1, Clause 3(7), Rule 2377-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M124"/>
   ...
   <!--PATTERN AdSupportedTetheredDownloadService_CommercialModelType-->
	  ...
	  <!--RULE -->
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedTetheredDownloadService')]"
                 priority="1000"
                 mode="M125">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedTetheredDownloadService')]"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be AdvertisementSupportedModel for this Profile (Business Profile 1.3.1, Clause 3(8), Rule 2378-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M125"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be ConditionalDownload for this Profile (Business Profile 1.3.1, Clause 3(8), Rule 2379-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M126"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedTetheredDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(8), Rule 2380-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M127"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedTetheredDownloadService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(8), Rule 2381-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M128"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'ConditionalDownload']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedTetheredDownloadService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/AdSupportedTetheredDownloadService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/AdSupportedTetheredDownloadService' for this combination of categories (Business Profile 1.3.1, Clause 3(8), Rule 2382-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M129"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be SubscriptionModel for this Profile (Business Profile 1.3.1, Clause 3(9), Rule 2383-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M130"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be OnDemandStream for this Profile (Business Profile 1.3.1, Clause 3(9), Rule 2384-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M131"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(9), Rule 2385-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M132"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(9), Rule 2386-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M133"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'SubscriptionModel']][Usage/UseType[text() = 'OnDemandStream']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveSubscriptionStreamingService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/InteractiveSubscriptionStreamingService' for this combination of categories (Business Profile 1.3.1, Clause 3(9), Rule 2387-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M134"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be AdvertisementSupportedModel for this Profile (Business Profile 1.3.1, Clause 3(10), Rule 2388-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M135"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be OnDemandStream for this Profile (Business Profile 1.3.1, Clause 3(10), Rule 2389-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M136"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(10), Rule 2390-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M137"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(10), Rule 2391-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M138"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertismentSupportedModel']][Usage/UseType[text() = 'OnDemandStream']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveAdSupportedStreamingService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/InteractiveAdSupportedStreamingService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/InteractiveAdSupportedStreamingService' for this combination of categories (Business Profile 1.3.1, Clause 3(10), Rule 2392-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M139"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be SubscriptionModel for this Profile (Business Profile 1.3.1, Clause 3(11), Rule 2393-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M140"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be NonInteractiveStream for this Profile (Business Profile 1.3.1, Clause 3(11), Rule 2394-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M141"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(11), Rule 2395-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M142"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(11), Rule 2396-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M143"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'SubscriptionModel']][Usage/UseType[text() = 'NonInteractiveStream']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(/*:NewReleaseMessage/@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(/*:NewReleaseMessage/@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingService' for this combination of categories (Business Profile 1.3.1, Clause 3(11), Rule 2397-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M144"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be DeviceFeeModel for this Profile (Business Profile 1.3.1, Clause 3(12), Rule 2398-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M145"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be NonInteractiveStream for this Profile (Business Profile 1.3.1, Clause 3(12), Rule 2399-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M146"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(12), Rule 2400-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M147"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(12), Rule 2401-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M148"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'DeviceFeeModel']][Usage/UseType[text() = 'NonInteractiveStream']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/NonInteractiveSubscriptionStreamingServiceOnDevice' for this combination of categories (Business Profile 1.3.1, Clause 3(12), Rule 2402-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M149"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be AdvertisementSupportedModel for this Profile (Business Profile 1.3.1, Clause 3(13), Rule 2403-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M150"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be NonInteractiveStream for this Profile (Business Profile 1.3.1, Clause 3(13), Rule 2404-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M151"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(13), Rule 2405-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M152"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(13), Rule 2406-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M153"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertismentSupportedModel']][Usage/UseType[text() = 'NonInteractiveStream']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/NonInteractiveAdSupportedStreamingService' for this combination of categories (Business Profile 1.3.1, Clause 3(13), Rule 2407-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M154"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for this Profile (Business Profile 1.3.1, Clause 3(14), Rule 2408-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M155"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile (Business Profile 1.3.1, Clause 3(14), Rule 2409-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M156"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UserInterfaceType should be Kiosk for this Profile (Business Profile 1.3.1, Clause 3(14), Rule 2410-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M157"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/KioskService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(14), Rule 2411-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'PermanentDonwload']][Usage/UserInterfaceType[text() = 'Kiosk']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/KioskService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/KioskService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/KioskService' for this combination of categories (Business Profile 1.3.1, Clause 3(14), Rule 2412-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M159"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for this Profile (Business Profile 1.3.1, Clause 3(15), Rule 2413-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M160"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be UseAsRingtone, UseAsRingbackTone or UseAsAlertTone for this Profile (Business Profile 1.3.1, Clause 3(15), Rule 2414-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M161"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RingtonesAndMobileService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(15), Rule 2415-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M162"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RingtonesAndMobileService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(15), Rule 2416-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M163"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[starts-with(text(),'UseAs')][ends-with(text(),'one')]]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/RingtonesAndMobileService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/RingtonesAndMobileService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/RingtonesAndMobileService' for this combination of categories (Business Profile 1.3.1, Clause 3(15), Rule 2417-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M164"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be RightsClaimModel for this Profile (Business Profile 1.3.1, Clause 3(16), Rule 2418-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M165"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be UserMakeAvailableLabelProvided or UserMakeAvailableUserProvided for this Profile (Business Profile 1.3.1, Clause 3(16), Rule 2419-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M166"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(16), Rule 2420-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M167"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(16), Rule 2421-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M168"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/RightsClaimsOnUserGeneratedContent' for this combination of categories (Business Profile 1.3.1, Clause 3(16), Rule 2422-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M169"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be PurchaseAsPhysicalProduct for this Profile (Business Profile 1.3.1, Clause 3(17), Rule 2423-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M170"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/PurchaseAsPhysicalProduct')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(17), Rule 2424-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M171"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/PurchaseAsPhysicalProduct')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(17), Rule 2425-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M172"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms/Usage/UseType[text() = 'PurchaseAsPhysicalProduct']"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/PurchaseAsPhysicalProduct')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/PurchaseAsPhysicalProduct')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/PurchaseAsPhysicalProduct' for this combination of categories (Business Profile 1.3.1, Clause 3(17), Rule 2426-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M173"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be AdvertisementSupportedModel for this Profile (Business Profile 1.3.1, Clause 3(18), Rule 2427-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M174"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be Stream for this Profile (Business Profile 1.3.1, Clause 3(18), Rule 2428-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M175"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(18), Rule 2429-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M176"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericAdSupportedStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(18), Rule 2430-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M177"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertismentSupportedModel']][Usage/UseType[text() = 'Stream']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/GenericAdSupportedStreamingService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/GenericAdSupportedStreamingService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/GenericAdSupportedStreamingService' for this combination of categories (Business Profile 1.3.1, Clause 3(18), Rule 2431-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M178"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be SubscriptionModel for this Profile (Business Profile 1.3.1, Clause 3(19), Rule 2432-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M179"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be Stream for this Profile (Business Profile 1.3.1, Clause 3(19), Rule 2433-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M180"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(19), Rule 2434-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M181"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericSubscriptionStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(19), Rule 2435-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M182"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'SubscriptionModel']][Usage/UseType[text() = 'Stream']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/GenericSubscriptionStreamingService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/GenericSubscriptionStreamingService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/GenericSubscriptionStreamingService' for this combination of categories (Business Profile 1.3.1, Clause 3(19), Rule 2436-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M183"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for this Profile (Business Profile 1.3.1, Clause 3(20), Rule 2437-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M184"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Fatal Error: The UseType should be Stream for this Profile (Business Profile 1.3.1, Clause 3(20), Rule 2438-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M185"/>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericPayAsYouGoStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UserInterfaceType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The UserInterfaceType should not used for this Profile (Business Profile 1.3.1, Clause 3(20), Rule 2439-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M186"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/131/GenericPayAsYouGoStreamingService')]"
      ...
      <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Error: The DistributionChannelType should not used for this Profile (Business Profile 1.3.1, Clause 3(20), Rule 2440-1).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M187"/>
   </xsl:template>
   ...
   <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'Stream']]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT Fatal Error-->
      <xsl:choose>
         <xsl:when test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/GenericPayAsYouGoStreamingService')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="contains(//@BusinessProfileVersionId, 'CommonDealTypes/131/GenericPayAsYouGoStreamingService')">
               <xsl:attribute name="role">Fatal Error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Fatal Error: The BusinessProfileVersionId should contain 'CommonDealTypes/131/GenericPayAsYouGoStreamingService' for this combination of categories (Business Profile 1.3.1, Clause 3(20), Rule 2441-1).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M188"/>
