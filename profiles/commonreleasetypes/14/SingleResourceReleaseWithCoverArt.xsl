...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--SCHEMATRON PATTERNS-->
    <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Release Profile for Single Resource With Cover Art
        (version 1.4) for the
        NewReleaseMessage.
    </svrl:text>
        ...
        <xsl:if test="MidiDetailsByTerritory/RemasteredDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information:
                    #Single Resource With Cover Art) No deprecated date elements should be used.
                </svrl:text>
        ...
        <xsl:if test="MIDI/MasteredDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="MIDI/MasteredDate">
                ...
                <svrl:text>Information: #Single Resource With
                    Cover Art) No deprecated date elements should be used.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="Release/GlobalReleaseDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information: #Single Resource
                    With Cover Art) No deprecated date elements should be used.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="Release/GlobalOriginalReleaseDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information: #Single
                    Resource With Cover Art) No deprecated date elements should be used.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="ResourceGroup">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceGroup">
                ...
                <svrl:text>Information: #Single Resource With Cover
                    Art) There should not be more than 5 nested ResourceGroups.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M8"/>
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &lt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    flag = True (Release Profile 1.4, Clause 3.3.1(1), Rule 2039-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    been specified (Release Profile 1.4, Clause 3.3.1(1), Rule 2039-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M11"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
                    ...
                    <svrl:text>Fatal Error: #Single Resource With Cover
                        ...
                        3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 2040-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="SequenceNumber">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
                ...
                <svrl:text>Error: #Single Resource With Cover Art)
                    ...
                    Profile 1.4, Clause 3.3.1(4), Rule 2044-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M16"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Fatal Error: #Single Resource With Cover Art)
                        ...
                        1.4, Clause 3.3.1(6), Rule 2045-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@ReleaseResourceType">
                    ...
                    <svrl:text>Fatal Error: #Single Resource With
                        ...
                        (Release Profile 1.4, Clause 4.3(1)+4.3(2), Rule 2046-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single Resource With Cover Art) At least one Title of
                        ...
                        section (Release Profile 1.4, Clause 4.3(4), Rule 2049-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single Resource With Cover Art) At least one Title of
                        ...
                        section (Release Profile 1.4, Clause 4.3(4), Rule 2050-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Single Resource With
                        ...
                        for a LabelName (Release Profile 1.4, Clause 4.3(6b), Rule 2055-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Single Resource With Cover Art) The appropriate ParentalWarningType
                        shall be provided (Release Profile 1.4, Clause 4.3(8), Rule 2057-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="*/*/DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="*/*/DisplayArtistName">
                ...
                <svrl:text>Error: #Single Resource With Cover Art)
                    ...
                    the Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 2063-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M37"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Fatal Error: #Single Resource With Cover Art)
                        ...
                        Profile 1.4, Clause 4.3(21), Rule 2064-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS'">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error:
                    ...
                    Profile 1.4, Clause 4.3(25), Rule 2070-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M44"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single
                        ...
                        pattern [0-9]{15}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 2071-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single
                        ...
                        [a-zA-Z0-9]{18} (Release Profile 1.4, Clause 4.3(30), Rule 2073-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        [0-9]{4}-[0-9]{3}[X0-9].+ (Release Profile 1.4, Clause 4.3(30), Rule 2074-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        [0-9]{4}-[0-9]{3}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 2075-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        97[8-9][0-9]{9}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 2076-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 2077-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 2078-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single
                        ...
                        979[0-9]{9}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 2079-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single
                        ...
                        [a-zA-Z][0-9]{10} (Release Profile 1.4, Clause 4.3(30), Rule 2080-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        [0-9]{8} or [0-9]{12,14} (Release Profile 1.4, Clause 4.3(30), Rule 2081-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=".='UserDefined'">
                    ...
                    <svrl:text>Fatal Error: #Single Resource With
                        ...
                        Profile 1.4, Clause 4.3(31), Rule 2082-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@Namespace">
                    ...
                    <svrl:text>Fatal Error: #Single Resource With Cover
                        ...
                        Profile 1.4, Clause 4.3(31), Rule 2082-2).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="//Comment">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
                ...
                <svrl:text>Error: #Single Resource With Cover Art) No Comment
                    shall be provided (Release Profile 1.4, Clause 4.3(32), Rule 2083-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M57"/>
    ...
    <xsl:template match="//*[@SequenceNumber]" priority="1000" mode="M60">
        ...
        <xsl:if test="@SequenceNumber=following-sibling::*[name()=name(current())]/@SequenceNumber">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Single Resource With Cover Art) SequenceNumbers must
                    all be different (Release Profile 1.4, Clause 4.3(35), Rule 2086-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M60"/>
        ...
        <xsl:if test="number(.) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &gt; 1">
                ...
                <svrl:text>Fatal Error: #Single Resource With
                    ...
                    (Release Profile 1.4, Clause 4.3(36a), Rule 2087-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M61"/>
        ...
        <xsl:if test="number(.) &lt;= 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &lt;= 1">
                ...
                <svrl:text>Information: #Single Resource With
                    ...
                    1.4, Clause 4.3(36b), Rule 2088-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M62"/>
        ...
        <xsl:if test="number(.) &lt;= 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &lt;= 1">
                ...
                <svrl:text>Information: #Single Resource With
                    Cover Art) Percentages are typically provided in the interval between 0 and 100. The
                    value provided seems to indicate a value equal to, or less than, 1% (Release Profile
                    1.4, Clause 4.3(36b), Rule 2089-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M63"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Single Resource With Cover Art) Primary Video Resources should be
                        identified with an ISRC (Release Profile 1.4, Clause 3.1, Rule 2091-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        #Single Resource With Cover Art) A Single Resource Release must contain exactly two Resources
                        (Release Profile 1.4, Clause 3.1, Rule 2092-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        Profile 1.4, Clause 4.3(12c)+4.3(15b), Rule 2095-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Single
                        ...
                        structure (Release Profile 1.4, Clause 4, Rule 2097-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.18(8), Rule 2101-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
