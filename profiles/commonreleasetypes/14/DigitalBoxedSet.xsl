...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--SCHEMATRON PATTERNS-->
    <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Release Profile for Digital Boxed Set (version
        1.4) for the
        NewReleaseMessage.
    </svrl:text>
        ...
        <xsl:if test="MidiDetailsByTerritory/RemasteredDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information:
                    #Digital Boxed Set) No deprecated date elements should be used.
                </svrl:text>
        ...
        <xsl:if test="Release/GlobalReleaseDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information: #Digital Boxed
                    Set) No deprecated date elements should be used.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="Release/GlobalOriginalReleaseDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information: #Digital
                    Boxed Set) No deprecated date elements should be used.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &lt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    (Release Profile 1.4, Clause 3.3.1(1), Rule 1553-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    (Release Profile 1.4, Clause 3.3.1(1), Rule 1553-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M11"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
                    ...
                    <svrl:text>Fatal Error: #Digital Boxed Set) Track
                        ...
                        3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 1554-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@ReleaseResourceType">
                    ...
                    <svrl:text>Fatal Error: #Digital Boxed Set)
                        ...
                        Profile 1.4, Clause 4.3(1)+4.3(2), Rule 1560-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital Boxed Set) At least one Title of type
                        ...
                        section (Release Profile 1.4, Clause 4.3(4), Rule 1563-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital Boxed Set) At least one Title of type
                        ...
                        section (Release Profile 1.4, Clause 4.3(4), Rule 1564-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Digital Boxed Set) If more than one LabelName is provided, exactly one shall be
                        a DisplayLabelName (Release Profile 1.4, Clause 4.3(6), Rule 1567-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Digital Boxed Set) The
                        ...
                        (Release Profile 1.4, Clause 4.3(6b), Rule 1569-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Digital Boxed Set) The appropriate ParentalWarningType shall be
                        provided (Release Profile 1.4, Clause 4.3(8), Rule 1571-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Error: #Digital Boxed Set) A ResourceReleaseDate or
                        ...
                        to the Message Sender (Release Profile 1.4, Clause 4.3(10), Rule 1573-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="*/*/DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="*/*/DisplayArtistName">
                ...
                <svrl:text>Error: #Digital Boxed Set) The
                    ...
                    Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 1577-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M37"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Fatal Error: #Digital Boxed Set)
                        ...
                        Profile 1.4, Clause 4.3(21), Rule 1578-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="sum(//RightShare/RightSharePercentage) &gt; 100">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    must not exceed 100% (Release Profile 1.4, Clause 4.3(22), Rule 1579-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M39"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital Boxed Set) A RightSharePercentage has a value
                        between 0 and 100 (Release Profile 1.4, Clause 4.3(22), Rule 1580-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS' and number() != .">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Digital Boxed Set) A TerritoryCode of type 'TIS' must
                    be a numeric code (Release Profile 1.4, Clause 4.3(25), Rule 1583-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Digital Boxed Set) A deprecated TerritoryCode must be a
                    four-letter code (Release Profile 1.4, Clause 4.3(25), Rule 1583-3).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M43"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital
                        ...
                        [0-9]{15}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1585-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1587-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        [0-9]{4}-[0-9]{3}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1589-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        97[8-9][0-9]{9}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1590-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1591-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1592-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1593-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1594-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        [0-9]{12,14} (Release Profile 1.4, Clause 4.3(30), Rule 1595-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="//Comment">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
                ...
                <svrl:text>Error: #Digital Boxed Set) No Comment shall be
                    provided (Release Profile 1.4, Clause 4.3(32), Rule 1597-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M57"/>
        ...
        <xsl:if test="@SequenceNumber=following-sibling::*[name()=name(current())]/@SequenceNumber">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Digital Boxed Set) SequenceNumbers must all be
                    different (Release Profile 1.4, Clause 4.3(35), Rule 1600-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M60"/>
        ...
        <xsl:if test="number(.) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &gt; 1">
                ...
                <svrl:text>Fatal Error: #Digital Boxed Set) A
                    ...
                    Profile 1.4, Clause 4.3(36a), Rule 1601-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M61"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Digital Boxed Set) A Digital Box Set must contain one DigitalBoxSet
                        release (Release Profile 1.4, Clause 3.1, Rule 1605-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Image">
                    ...
                    <svrl:text>Error: #Digital Boxed Set) A Release of this type must
                        contain at least one Image (Release Profile 1.4, Clause 3.1, Rule 1607-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal
                        ...
                        (Release Profile 1.4, Clause 3.1, Rule 1608-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="count(ReleaseResourceReference) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error:
                    ...
                    Profile 1.4, Clause 3.1, Rule 1609-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M69"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        Clause 4.3(12c)+4.3(15b), Rule 1612-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="ReleaseDetailsByTerritory/DisplayArtistName = ReleaseResourceReferenceList/descendant::DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: #Digital Boxed Set) DisplayArtistNames for Release and Resource must
                    be different (Release Profile 1.4, Clause 4.3(16a), Rule 1613-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M73"/>
