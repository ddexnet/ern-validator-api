...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">MultiProfile_PrimarySoundRecordingMustHaveIndirectSoundRecordingId
                </xsl:attribute>
                <xsl:attribute name="name">MultiProfile_PrimarySoundRecordingMustHaveIndirectSoundRecordingId
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">LongformVideo_PrimaryVideoResourceMustHaveSoundRecordingCollectionReference
                </xsl:attribute>
                <xsl:attribute name="name">LongformVideo_PrimaryVideoResourceMustHaveSoundRecordingCollectionReference
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">LongformVideo_SoundRecordingCollectionReferenceMustHaveStartTime
                </xsl:attribute>
                <xsl:attribute name="name">LongformVideo_SoundRecordingCollectionReferenceMustHaveStartTime
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
    ...
    <!--SCHEMATRON PATTERNS-->
    <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Release Profile for Longform Video (version 1.4)
        for the
        NewReleaseMessage.
    </svrl:text>
        ...
        <xsl:if test="MidiDetailsByTerritory/RemasteredDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information:
                    #Longform Video) No deprecated date elements should be used.
                </svrl:text>
        ...
        <xsl:if test="MIDI/MasteredDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="MIDI/MasteredDate">
                ...
                <svrl:text>Information: #Longform Video) No
                    deprecated date elements should be used.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="Release/GlobalReleaseDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information: #Longform Video)
                    No deprecated date elements should be used.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup"
            priority="1000"
            mode="M8">
        ...
        <xsl:if test="ResourceGroup">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceGroup">
                ...
                <svrl:text>Information: #Longform Video) There
                    should not be more than 5 nested ResourceGroups.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M8"/>
    ...
    <xsl:template match="*:NewReleaseMessage/ResourceList/SoundRecording"
        ...
        <xsl:if test="IsHiddenResource">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="IsHiddenResource">
                ...
                <svrl:text>Information: #Longform Video) No
                    deprecated Flags (IsHiddenResource) must be provided for SoundRecordings.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="IsBonusResource">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="IsBonusResource">
                ...
                <svrl:text>Information: #Longform Video) No
                    deprecated Flags (IsBonusResource) must be provided for SoundRecordings.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M9"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']] | *:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']] | *:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']] | *:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']] | *:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']] | *:NewReleaseMessage/ReleaseList/Release[1]/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']]"
            priority="1000"
            mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &lt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    (Release Profile 1.4, Clause 3.3.1(1), Rule 1380-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="count(Release) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(Release) &gt; 1">
                ...
                <svrl:text>Fatal
                    ...
                    (Release Profile 1.4, Clause 3.3.1(1), Rule 1380-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M11"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/ReleaseList/Release/*/ResourceGroup/ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']]"
            priority="1000"
            mode="M12">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Track
                        ...
                        3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 1381-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/ReleaseList/Release[@IsMainRelease = 'true']/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroup"
            priority="1000"
            mode="M14">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="//Release[@IsMainRelease = 'true']/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference/@ReleaseResourceType='PrimaryResource']"
            priority="1000"
            mode="M15">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="//ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]"
            priority="1000"
            mode="M16">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="//ResourceGroupContentItem[ResourceType = 'SoundRecording']/ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']"
            priority="1000"
            mode="M17">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@ReleaseResourceType">
                    ...
                    <svrl:text>Fatal Error: #Longform Video) For
                        ...
                        1.4, Clause 4.3(1)+4.3(2), Rule 1387-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) At least one Title of type FormalTitle
                        ...
                        Profile 1.4, Clause 4.3(4), Rule 1390-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) At least one Title of type DisplayTitle
                        shall be provided for the default Worldwide ReleaseDetailsByTerritory section (Release
                        Profile 1.4, Clause 4.3(4), Rule 1391-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="count(ReleaseDetailsByTerritory)=count(ReleaseDetailsByTerritory/PLine)">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: A PLine shall not be provided in all
                    ReleaseDetailsByTerritory (Release Profile 1.4, Clause 4.3(5a), Rule 1017-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M23"/>
        ...
        <xsl:if test="ReleaseDetailsByTerritory[not(PLine)]">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: A
                    ...
                    provided for Release (Release Profile 1.4, Clause 4.3(5a), Rule 1017-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M24"/>
        ...
        <xsl:if test="count(ReleaseDetailsByTerritory)=count(ReleaseDetailsByTerritory/CLine)">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: A CLine shall not be provided in all
                    ReleaseDetailsByTerritory (Release Profile 1.4, 1017-1NR).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M25"/>
        ...
        <xsl:if test="ReleaseDetailsByTerritory[not(CLine)]">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: A
                    ...
                    provided for Release (Release Profile 1.4, 1017-1NR).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M26"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Longform Video) If more than one LabelName is provided, exactly one shall be a
                        DisplayLabelName (Release Profile 1.4, Clause 4.3(6), Rule 1394-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Longform Video) The
                        ...
                        (Release Profile 1.4, Clause 4.3(6b), Rule 1396-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Longform Video) The appropriate ParentalWarningType shall be
                        provided (Release Profile 1.4, Clause 4.3(8), Rule 1398-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Error: #Longform Video) A ResourceReleaseDate or an
                        ...
                        the Message Sender (Release Profile 1.4, Clause 4.3(10), Rule 1400-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="*/*/DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="*/*/DisplayArtistName">
                ...
                <svrl:text>Error: #Longform Video) The
                    ...
                    Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 1404-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M37"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Fatal Error: #Longform Video)
                        ...
                        Profile 1.4, Clause 4.3(21), Rule 1405-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="sum(//RightShare/RightSharePercentage) &gt; 100">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    not exceed 100% (Release Profile 1.4, Clause 4.3(22), Rule 1406-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M39"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) A RightSharePercentage has a value
                        between 0 and 100 (Release Profile 1.4, Clause 4.3(22), Rule 1407-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS' and number() != .">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Longform Video) A TerritoryCode of type 'TIS' must be a
                    numeric code (Release Profile 1.4, Clause 4.3(25), Rule 1410-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Longform Video) A deprecated TerritoryCode must be a
                    four-letter code (Release Profile 1.4, Clause 4.3(25), Rule 1410-3).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M43"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform
                        ...
                        [0-9]{15}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1412-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1414-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        [0-9]{4}-[0-9]{3}[X0-9].+ (Release Profile 1.4, Clause 4.3(30), Rule 1415-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        [0-9]{4}-[0-9]{3}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1416-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        97[8-9][0-9]{9}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1417-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1420-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1421-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        [0-9]{12,14} (Release Profile 1.4, Clause 4.3(30), Rule 1422-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="//Comment">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
                ...
                <svrl:text>Error: #Longform Video) No Comment shall be
                    provided (Release Profile 1.4, Clause 4.3(32), Rule 1424-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M57"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: SequenceNumbers must run from 1 to the number of
                        sequenced elements (Release Profile 1.4, Clause 4.3(35), Rule 1669-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="@SequenceNumber=following-sibling::*[name()=name(current())]/@SequenceNumber">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Longform Video) SequenceNumbers must all be different
                    (Release Profile 1.4, Clause 4.3(35), Rule 1427-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M60"/>
        ...
        <xsl:if test="number(.) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(.) &gt; 1">
                ...
                <svrl:text>Fatal Error: #Longform Video) A
                    ...
                    Profile 1.4, Clause 4.3(36a), Rule 1428-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M61"/>
    ...
    <!--RULE -->
    <xsl:template
            match="//Release[@IsMainRelease='true']/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroupContentItem"
            priority="1000"
            mode="M66">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/ReleaseList/Release[ReleaseType[text() = 'TrackRelease']]/ReleaseResourceReferenceList"
            priority="1000"
            mode="M68">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="count(ReleaseResourceReference) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error:
                    ...
                    Profile 1.4, Clause 3.1, Rule 1435-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M68"/>
    ...
    <!--RULE -->
    <xsl:template
            match="//ResourceGroupContentItem[ResourceType = 'Video']/ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']"
            priority="1000"
            mode="M69">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Longform Video) Primary Video Resources should be identified with
                        an ISRC (Release Profile 1.4, Clause 3.1, Rule 1436-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) A Longform Video must contain at least
                        ...
                        Profile 1.4, Clause 3.1, Rule 1437-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        Clause 4.3(12c)+4.3(15b), Rule 1440-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="ReleaseDetailsByTerritory/DisplayArtistName = ReleaseResourceReferenceList/descendant::DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: #Longform Video) DisplayArtistNames for Release and Resource must be
                    different (Release Profile 1.4, Clause 4.3(16a), Rule 1441-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M74"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Primary SoundRecording Resources shall
                        be identified with an ISRC (Release Profile 1.4, Clause 4.8(5), Rule 1443-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']"
            priority="1000"
            mode="M77">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Secondary Resources shall be identified
                        by a ProprietaryId (Release Profile 1.4, Clause 4.8(6), Rule 1444-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Longform Video) Each primary Longform video resource should have a
                        ...
                        (Release Profile 1.4, Clause 4.8(9a), Rule 1445-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Cue">
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Each CueSheet will
                        consist of 1 to many Cues (Release Profile 1.4, Clause 4.8(9b), Rule 1446-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Each Cue should have a StartTime
                        (Release Profile 1.4, Clause 4.8(9c), Rule 1447-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Each Cue should have an ISRC or an ISWC
                        (Release Profile 1.4, Clause 4.8(9e1), Rule 1448-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Longform Video) Each Cue should have a ReferencedCreationTitle of
                        type DisplayTitle (Release Profile 1.4, Clause 4.8(9e2), Rule 1450-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="PLine">
                    ...
                    <svrl:text>Error: #Longform Video) Each Cue should have a PLine
                        (Release Profile 1.4, Clause 4.8(9e3), Rule 1452-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error:
                        ...
                        1.4, Clause 4.8(9e4), Rule 1453-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="CLine">
                    ...
                    <svrl:text>Error: #Longform Video) Each Cue should have a CLine
                        (Release Profile 1.4, Clause 4.8(9e6), Rule 1454-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.8(10a), Rule 1455-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Each Collection item should have a
                        Proprietary CollectionId (Release Profile 1.4, Clause 4.8(10b), Rule 1456-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Title">
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Each Collection
                        item should have a Title (Release Profile 1.4, Clause 4.8(10c), Rule 1457-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="Video[ResourceReference = //ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']]/VideoCollectionReferenceList/SoundRecordingCollectionReference/SoundRecordingCollectionReference"
            priority="1000"
            mode="M93">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) The primary Video resource should have
                        ...
                        Profile 1.4, Clause 4.8(10g), Rule 1460-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="Video[ResourceReference = //ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']]/VideoCollectionReferenceList/SoundRecordingCollectionReference"
            priority="1000"
            mode="M94">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Longform Video) Each SoundRecordingCollectionReference
                        ...
                        on the Video (Release Profile 1.4, Clause 4.8(10h), Rule 1461-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
