        ...
        <xsl:if test="MidiDetailsByTerritory/RemasteredDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information:
                    #Ringtone) No deprecated date elements should be used.
                </svrl:text>
        ...
        <xsl:if test="ResourceGroup">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceGroup">
                ...
                <svrl:text>Information: #Ringtone) There should not
                    be more than 5 nested ResourceGroups.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M8"/>
    ...
    <xsl:template match="*:NewReleaseMessage/ResourceList/SoundRecording"
        ...
        <xsl:if test="IsHiddenResource">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="IsHiddenResource">
                ...
                <svrl:text>Information: #Ringtone) No deprecated
                    Flags (IsHiddenResource) must be provided for SoundRecordings.
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &lt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    Profile 1.4, Clause 3.3.1(1), Rule 1302-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    Profile 1.4, Clause 3.3.1(1), Rule 1302-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M11"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
                    ...
                    <svrl:text>Fatal Error: #Ringtone) Track bundle
                        ...
                        3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 1303-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber &gt; '1'] and not(descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber = '1'])">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Ringtone) All Primary Resources should be sequenced in
                    ...
                    next track bundle) (Release Profile 1.4, Clause 3.3.1(3), Rule 1305-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M14"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@ReleaseResourceType">
                    ...
                    <svrl:text>Fatal Error: #Ringtone) For each
                        ...
                        Clause 4.3(1)+4.3(2), Rule 1309-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Ringtone) A Single ReferenceTitle must be provided for
                        each SoundRecording (Release Profile 1.4, Clause 4.3(4), Rule 1311-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Ringtone) If more than one LabelName is provided, exactly one shall be a
                        DisplayLabelName (Release Profile 1.4, Clause 4.3(6), Rule 1316-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Ringtone) The
                        ...
                        (Release Profile 1.4, Clause 4.3(6b), Rule 1318-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Ringtone) The appropriate ParentalWarningType shall be provided
                        (Release Profile 1.4, Clause 4.3(8), Rule 1320-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Error: #Ringtone) A ResourceReleaseDate or an
                        ...
                        the Message Sender (Release Profile 1.4, Clause 4.3(10), Rule 1322-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="*/*/DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="*/*/DisplayArtistName">
                ...
                <svrl:text>Error: #Ringtone) The
                    ...
                    Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 1326-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M37"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Fatal Error: #Ringtone)
                        ...
                        Profile 1.4, Clause 4.3(21), Rule 1327-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="sum(//RightShare/RightSharePercentage) &gt; 100">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    exceed 100% (Release Profile 1.4, Clause 4.3(22), Rule 1328-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M39"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Ringtone) A RightSharePercentage has a value between 0
                        and 100 (Release Profile 1.4, Clause 4.3(22), Rule 1329-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS' and number() != .">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Ringtone) A TerritoryCode of type 'TIS' must be a
                    numeric code (Release Profile 1.4, Clause 4.3(25), Rule 1332-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Ringtone) A deprecated TerritoryCode must be a
                    four-letter code (Release Profile 1.4, Clause 4.3(25), Rule 1332-3).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M43"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Ringtone)
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1334-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1337-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1338-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1339-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1342-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1343-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1344-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="//Comment">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
                ...
                <svrl:text>Error: #Ringtone) No Comment shall be provided
                    (Release Profile 1.4, Clause 4.3(32), Rule 1346-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M57"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Ringtone) SequenceNumbers must run from 1 to the number
                        of sequenced elements (Release Profile 1.4, Clause 4.3(35), Rule 1349-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="@SequenceNumber=following-sibling::*[name()=name(current())]/@SequenceNumber">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #Ringtone) SequenceNumbers must all be different
                    (Release Profile 1.4, Clause 4.3(35), Rule 1349-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M60"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #Ringtone) Primary Video Resources should be identified with an ISRC
                        (Release Profile 1.4, Clause 3.1, Rule 1355-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Ringtone) A Ringtone must contain one RingtoneRelease
                        or RingbackToneRelease (Release Profile 1.4, Clause 3.1, Rule 1356-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="ReleaseDetailsByTerritory/DisplayArtistName = ReleaseResourceReferenceList/descendant::DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: #Ringtone) DisplayArtistNames for Release and Resource must be
                    different (Release Profile 1.4, Clause 4.3(16a), Rule 1359-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M70"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Ringtone) The MainRelease shall be identified by either
                        a GRid or by an ICPN (Release Profile 1.4, Clause 4.9(4), Rule 1360-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Ringtone) Primary SoundRecording Resources shall be
                        identified with an ISRC (Release Profile 1.4, Clause 4.9(5), Rule 1361-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #Ringtone) A Ringtone must contain a RelatedRelease of
                        type IsReleaseFromRelease (Release Profile 1.4, Clause 4.9(9), Rule 1362-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
