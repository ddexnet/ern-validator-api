...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>This ISO Schematron file is, together with all DDEX standards, subject to two licences: If
                ...
                Licence. For details please go to http://ddex.net/apply-ddex-implementation-licence.
            </svrl:text>
            <svrl:text>Failing a rule with a role of 'Fatal Error' means that the Conformance Tester must recommend
                ...
                asserting whether the condition expressed in the rule has been met.
            </svrl:text>
            <svrl:text>Failing a rule a rule with a role of 'Error' means that the Conformance Tester must
                ...
                means of asserting whether the condition expressed in the rule has been met.
            </svrl:text>
            <svrl:text>The following Clauses from the Business Profile standard are NOT checked by this ISO
                ...
                4.7.1(1)-(2), (5), 4.7.3, 4.7.4(1a), (1b), (2a), (2b), 4.7.5, 4.7.6, 4.7.7 and 4.8.
            </svrl:text>
            <svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingService_ConsumerRentalPeriod
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingServiceOnDevice_ConsumerRentalPeriod
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingServiceOnDevice_ConsumerRentalPeriod
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">NonInteractiveAdSupportedStreamingService_ConsumerRentalPeriod
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">InteractiveSubscriptionStreamingService_ReleaseProfileVersionId
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">InteractiveSubscriptionStreamingService_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:attribute name="name">InteractiveSubscriptionStreamingService_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">InteractiveSubscriptionStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:attribute name="name">InteractiveSubscriptionStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">InteractiveAdSupportedStreamingService_ReleaseProfileVersionId
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">InteractiveAdSupportedStreamingService_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">InteractiveAdSupportedStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:attribute name="name">InteractiveAdSupportedStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingService_MustNotContainDates
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingService_ReleaseProfileVersionId
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingService_ReleaseProfileVersionId
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingService_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingService_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingServiceOnDevice_MustNotContainDates
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingServiceOnDevice_MustNotContainDates
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingServiceOnDevice_ReleaseProfileVersionId
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingServiceOnDevice_ReleaseProfileVersionId
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingServiceOnDevice_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingServiceOnDevice_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">
                    NonInteractiveSubscriptionStreamingServiceOnDevice_MustNotContainPriceInformation
                </xsl:attribute>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveAdSupportedStreamingService_ReleaseProfileVersionId
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveAdSupportedStreamingService_ReleaseProfileVersionId
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveAdSupportedStreamingService_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveAdSupportedStreamingService_NoGenericBusinessProfile
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveAdSupportedStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveAdSupportedStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">GenericAdSupportedStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:attribute name="name">GenericAdSupportedStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">GenericSubscriptionStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:attribute name="name">GenericSubscriptionStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">GenericPayAsYouGoStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:attribute name="name">GenericPayAsYouGoStreamingService_MustNotContainPriceInformation
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">DRMProtectedAdSupportedDownloadService_DistributionChannelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">NonProtectedAdSupportedDownloadService_DistributionChannelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">InteractiveSubscriptionStreamingService_DistributionChannelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">InteractiveAdSupportedStreamingService_DistributionChannelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingService_CommercialModelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingService_DistributionChannelType
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingService_DistributionChannelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingServiceOnDevice_CommercialModelType
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingServiceOnDevice_CommercialModelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingServiceOnDevice_UserInterfaceType
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingServiceOnDevice_UserInterfaceType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveSubscriptionStreamingServiceOnDevice_DistributionChannelType
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveSubscriptionStreamingServiceOnDevice_DistributionChannelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
            ...
            <svrl:active-pattern>
                ...
                <xsl:attribute name="id">NonInteractiveAdSupportedStreamingService_DistributionChannelType
                </xsl:attribute>
                <xsl:attribute name="name">NonInteractiveAdSupportedStreamingService_DistributionChannelType
                </xsl:attribute>
                <xsl:apply-templates/>
            </svrl:active-pattern>
    ...
    <!--SCHEMATRON PATTERNS-->
    <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Business Profile for (version 1.4) for the
        NewReleaseMessage.
    </svrl:text>
        ...
        <xsl:if test="some $x in tokenize(@BusinessProfileVersionId, '\s+') satisfies not(contains('CommonDealTypes/14/GenericDownloadService CommonDealTypes/14/DRMProtectedDownloadService CommonDealTypes/14/NonProtectedDownloadService CommonDealTypes/14/AdSupportedDownloadService CommonDealTypes/14/DRMProtectedAdSupportedDownloadService CommonDealTypes/14/NonProtectedAdSupportedDownloadService CommonDealTypes/14/TetheredDownloadService CommonDealTypes/14/AdSupportedTetheredDownloadService CommonDealTypes/14/InteractiveSubscriptionStreamingService CommonDealTypes/14/InteractiveAdSupportedStreamingService CommonDealTypes/14/NonInteractiveSubscriptionStreamingService CommonDealTypes/14/NonInteractiveSubscriptionStreamingServiceOnDevice CommonDealTypes/14/NonInteractiveAdSupportedStreamingService CommonDealTypes/14/KioskService CommonDealTypes/14/RingtonesAndMobileService CommonDealTypes/14/RightsClaimsOnUserGeneratedContent CommonDealTypes/14/PurchaseAsPhysicalProduct CommonDealTypes/14/GenericAdSupportedStreamingService CommonDealTypes/14/GenericSubscriptionStreamingService  CommonDealTypes/14/GenericPayAsYouGoStreamingService',$x))">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information: The BusinessProfileVersionId should only contain values
                    specified in the standard (Business Profile 1.4, Clause 4.1, Rule 2260-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M7"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Information: The MessageSchemaVersionId should be at least 3.9
                        (Business Profile 1.4, Clause 4.1, Rule 2261-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="//Comment">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
                ...
                <svrl:text>Fatal Error: No Comment shall be provided in
                    the MessageHeader (Business Profile 1.4, Clause 4.2(3), Rule 2263-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M10"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[not(contains (@BusinessProfileVersionId, 'CommonDealTypes/14/PurchaseAsPhysicalProduct'))]"
            priority="1000"
            mode="M15">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="PhysicalReturns">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="PhysicalReturns">
                ...
                <svrl:text>Fatal Error: The use of PhysicalReturns
                    is discouraged (Business Profile 1.4, Clause 4.3.2(7), Rule 2269-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M16"/>
        ...
        <xsl:if test="ResourceUsage">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ResourceUsage">
                ...
                <svrl:text>Fatal Error: The use of ResourceUsage is
                    discouraged (Business Profile 1.4, Clause 4.3.2(10), Rule 2271-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M18"/>
    ...
    <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal"
        ...
        <xsl:if test="//Usage[UseType='Stream']/UseType[matches(text(),'.Stream')]">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: The combination of generic and specific UseTypes is not
                    permitted (Business Profile 1.4, Clause 4.3.2(12), Rule 2272-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="//Usage[UseType='Download']/UseType[matches(text(),'.Download')]">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: The combination of generic and specific UseTypes is not
                    permitted (Business Profile 1.4, Clause 4.3.2(12), Rule 2272-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M19"/>
    ...
    <xsl:template match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal"
        ...
        <xsl:if test="//Usage[UseType='InteractiveStream' and UseType='NonInteractiveStream' and UseType='ContentInfluencedStream' and UseType='OnDemandStream' and UseType='TimeInfluencedStream']">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: The use of all specific UseTypes is not permitted
                    (Business Profile 1.4, Clause 4.3.2(13), Rule 2273-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="//Usage[UseType='ConditionalDownload' and UseType='KioskDownload' and UseType='PermanentDownload' and UseType='TetheredDownload']">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: The use of all specific UseTypes is not permitted
                    (Business Profile 1.4, Clause 4.3.2(13), Rule 2273-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M20"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/PurchaseAsPhysicalProduct')]"
            priority="1000"
            mode="M37">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/CommercialModelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: No CommercialModelType should be specified for this Profile (Business
                    Profile 1.4, Clause 4.3.19(4), Rule 2290-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M37"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/GenericAdSupportedStreamingService')]"
            priority="1000"
            mode="M40">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UseType[text() = 'Narrowcast' or text() = 'NonInteractiveStream' or text() = 'OnDemandStream' or text() = 'TimeInfluencedStream' or text() = 'Webcast']">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: The UseType should not be a detailed streaming service
                    for this Profile (Business Profile 1.4, Clause 4.3.20(8), Rule 2293-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M40"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/GenericSubscriptionStreamingService')]"
            priority="1000"
            mode="M42">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UseType[text() = 'Narrowcast' or text() = 'NonInteractiveStream' or text() = 'OnDemandStream' or text() = 'TimeInfluencedStream' or text() = 'Webcast']">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: The UseType should not be a detailed streaming service
                    for this Profile (Business Profile 1.4, Clause 4.3.21(8), Rule 2295-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M42"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/GenericPayAsYouGoStreamingService')]"
            priority="1000"
            mode="M44">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/UseType[text() = 'Narrowcast' or text() = 'NonInteractiveStream' or text() = 'OnDemandStream' or text() = 'TimeInfluencedStream' or text() = 'Webcast']">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: The UseType should not be a detailed streaming service
                    for this Profile (Business Profile 1.4, Clause 4.3.22(8), Rule 2297-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M44"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/InteractiveSubscriptionStreamingService')]"
            priority="1000"
            mode="M45">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.11(6), Rule 2298-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.11(6), Rule 2298-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M45"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/InteractiveAdSupportedStreamingService')]"
            priority="1000"
            mode="M49">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.12(6), Rule 2302-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.12(6), Rule 2302-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M49"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/NonInteractiveSubscriptionStreamingService')]"
            priority="1000"
            mode="M53">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.13(6), Rule 2306-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.13(6), Rule 2306-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M53"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/NonInteractiveSubscriptionStreamingServiceOnDevice')]"
            priority="1000"
            mode="M57">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.14(6), Rule 2310-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.14(6), Rule 2310-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M57"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/NonInteractiveAdSupportedStreamingService')]"
            priority="1000"
            mode="M61">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.15(6), Rule 2314-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.15(6), Rule 2314-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M61"/>
    ...
    <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/KioskService')]"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.16(5), Rule 2318-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.16(5), Rule 2318-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M65"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/RingtonesAndMobileService')]"
            priority="1000"
            mode="M66">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.17(6), Rule 2319-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.17(6), Rule 2319-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M66"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        provided (Business Profile 1.4, Clause 4.3.18(3), Rule 2321-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        (Business Profile 1.4, Clause 4.3.18(4), Rule 2322-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/RightsClaimsOnUserGeneratedContent')]"
            priority="1000"
            mode="M70">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.18(8), Rule 2323-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.18(8), Rule 2323-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M70"/>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.20(6), Rule 2325-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.20(6), Rule 2325-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M72"/>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.21(6), Rule 2328-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.21(6), Rule 2328-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M75"/>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderReleaseDateTime">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderReleaseDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.22(6), Rule 2331-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate | DealList/ReleaseDeal/Deal/DealTerms/PreOrderPreviewDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The use of PreOrderPreviewDate(Time) is discouraged (Business
                    Profile 1.4, Clause 4.3.22(6), Rule 2331-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M78"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms/PriceInformation[BulkOrderWholesalePricePerUnit] | *:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms/PriceInformation[WholesalePricePerUnit]"
            priority="1000"
            mode="M81">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:if test="EffectiveDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="EffectiveDate">
                ...
                <svrl:text>Fatal Error: An EffectiveDate must not be
                    specified (Business Profile 1.4, Clause 4.7.1(3), Rule 2335-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M82"/>
        ...
        <xsl:if test="UpdateIndicator">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="UpdateIndicator">
                ...
                <svrl:text>Fatal Error: UpdateIndicator shall not
                    be used (Business Profile 1.4, Clause 4.7.2, Rule 2337-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M84"/>
        ...
        <xsl:if test="TakeDown">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="TakeDown">
                ...
                <svrl:text>Fatal Error: TakeDown must not be specified
                    (Business Profile 1.4, Clause 4.7.4(1c)+4.7.4(2c), Rule 2338-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M85"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/GenericDownloadService')]"
            priority="1000"
            mode="M86">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for
                        this Profile (Business Profile 1.4, Clause 3(1), Rule 2339-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile
                        (Business Profile 1.4, Clause 3(1), Rule 2340-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(1), Rule 2342-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M89"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() != 'DrmEnforced']][Usage/TechnicalInstantiation/DrmEnforcementType[text() != 'NotDrmEnforced']]"
            priority="1000"
            mode="M90">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        (Business Profile 1.4, Clause 3(1), Rule 2343-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/DRMProtectedDownloadService')]"
            priority="1000"
            mode="M91">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for
                        this Profile (Business Profile 1.4, Clause 3(2), Rule 2344-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile
                        (Business Profile 1.4, Clause 3(2), Rule 2345-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The DrmEnforcementType should be DrmEnforced for this
                        Profile (Business Profile 1.4, Clause 3(2), Rule 2346-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(2), Rule 2348-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M95"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() = 'DrmEnforced']]"
            priority="1000"
            mode="M96">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        (Business Profile 1.4, Clause 3(2), Rule 2349-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/NonProtectedDownloadService')]"
            priority="1000"
            mode="M97">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for
                        this Profile (Business Profile 1.4, Clause 3(3), Rule 2350-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile
                        (Business Profile 1.4, Clause 3(3), Rule 2351-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The DrmEnforcementType should be NotDrmEnforced for this
                        Profile (Business Profile 1.4, Clause 3(3), Rule 2352-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(3), Rule 2354-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M101"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() = 'NotDrmEnforced']]"
            priority="1000"
            mode="M102">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        (Business Profile 1.4, Clause 3(3), Rule 2355-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/AdSupportedDownloadService')]"
            priority="1000"
            mode="M103">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile
                        (Business Profile 1.4, Clause 3(4), Rule 2357-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(4), Rule 2359-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M106"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'PermanentDownload']]"
            priority="1000"
            mode="M107">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        (Business Profile 1.4, Clause 3(4), Rule 2360-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/DRMProtectedAdSupportedDownloadService')]"
            priority="1000"
            mode="M108">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile
                        (Business Profile 1.4, Clause 3(5), Rule 2362-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The DrmEnforcementType should be DrmEnforced for this
                        Profile (Business Profile 1.4, Clause 3(5), Rule 2363-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(5), Rule 2365-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M112"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() = 'DrmEnforced']]"
            priority="1000"
            mode="M113">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(5), Rule 2366-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/NonProtectedAdSupportedDownloadService')]"
            priority="1000"
            mode="M114">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile
                        (Business Profile 1.4, Clause 3(6), Rule 2368-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The DrmEnforcementType should be NotDrmEnforced for this
                        Profile (Business Profile 1.4, Clause 3(6), Rule 2369-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(6), Rule 2371-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M118"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'PermanentDownload']][Usage/TechnicalInstantiation/DrmEnforcementType[text() = 'NotDrmEnforced']]"
            priority="1000"
            mode="M119">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(6), Rule 2372-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/TetheredDownloadService')]"
            priority="1000"
            mode="M120">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be SubscriptionModel for
                        this Profile (Business Profile 1.4, Clause 3(7), Rule 2373-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be ConditionalDownload for this
                        Profile (Business Profile 1.4, Clause 3(7), Rule 2374-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(7), Rule 2376-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M123"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'SubscriptionModel']][Usage/UseType[text() = 'ConditionalDownload']]"
            priority="1000"
            mode="M124">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        (Business Profile 1.4, Clause 3(7), Rule 2377-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/AdSupportedTetheredDownloadService')]"
            priority="1000"
            mode="M125">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be ConditionalDownload for this
                        Profile (Business Profile 1.4, Clause 3(8), Rule 2379-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(8), Rule 2381-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M128"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertisementSupportedModel']][Usage/UseType[text() = 'ConditionalDownload']]"
            priority="1000"
            mode="M129">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(8), Rule 2382-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be SubscriptionModel for
                        this Profile (Business Profile 1.4, Clause 3(9), Rule 2383-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be OnDemandStream for this Profile
                        (Business Profile 1.4, Clause 3(9), Rule 2384-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(9), Rule 2386-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M133"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'SubscriptionModel']][Usage/UseType[text() = 'OnDemandStream']]"
            priority="1000"
            mode="M134">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(9), Rule 2387-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be OnDemandStream for this Profile
                        (Business Profile 1.4, Clause 3(10), Rule 2389-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(10), Rule 2391-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M138"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertismentSupportedModel']][Usage/UseType[text() = 'OnDemandStream']]"
            priority="1000"
            mode="M139">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(10), Rule 2392-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be SubscriptionModel for
                        this Profile (Business Profile 1.4, Clause 3(11), Rule 2393-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be NonInteractiveStream for this
                        Profile (Business Profile 1.4, Clause 3(11), Rule 2394-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(11), Rule 2396-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M143"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'SubscriptionModel']][Usage/UseType[text() = 'NonInteractiveStream']]"
            priority="1000"
            mode="M144">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(11), Rule 2397-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be DeviceFeeModel for
                        this Profile (Business Profile 1.4, Clause 3(12), Rule 2398-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be NonInteractiveStream for this
                        Profile (Business Profile 1.4, Clause 3(12), Rule 2399-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(12), Rule 2401-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M148"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'DeviceFeeModel']][Usage/UseType[text() = 'NonInteractiveStream']]"
            priority="1000"
            mode="M149">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        combination of categories (Business Profile 1.4, Clause 3(12), Rule 2402-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be NonInteractiveStream for this
                        Profile (Business Profile 1.4, Clause 3(13), Rule 2404-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(13), Rule 2406-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M153"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertismentSupportedModel']][Usage/UseType[text() = 'NonInteractiveStream']]"
            priority="1000"
            mode="M154">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(13), Rule 2407-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for
                        this Profile (Business Profile 1.4, Clause 3(14), Rule 2408-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be PermanentDownload for this Profile
                        (Business Profile 1.4, Clause 3(14), Rule 2409-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UserInterfaceType should be Kiosk for this Profile
                        (Business Profile 1.4, Clause 3(14), Rule 2410-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template match="*:NewReleaseMessage[contains(@BusinessProfileVersionId, 'CommonDealTypes/14/KioskService')]"
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(14), Rule 2411-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M158"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'PermanentDonwload']][Usage/UserInterfaceType[text() = 'Kiosk']]"
            priority="1000"
            mode="M159">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for
                        this Profile (Business Profile 1.4, Clause 3(15), Rule 2413-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(15), Rule 2416-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M163"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[starts-with(text(),'UseAs')][ends-with(text(),'one')]]"
            priority="1000"
            mode="M164">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        (Business Profile 1.4, Clause 3(15), Rule 2417-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be RightsClaimModel for
                        this Profile (Business Profile 1.4, Clause 3(16), Rule 2418-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(16), Rule 2421-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M168"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'RightsClaimModel']][Usage/UseType[starts-with(text(),'UserMakeAvailable')]]"
            priority="1000"
            mode="M169">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(16), Rule 2422-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be PurchaseAsPhysicalProduct for this
                        Profile (Business Profile 1.4, Clause 3(17), Rule 2423-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(17), Rule 2425-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M172"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms/Usage/UseType[text() = 'PurchaseAsPhysicalProduct']"
            priority="1000"
            mode="M173">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        (Business Profile 1.4, Clause 3(17), Rule 2426-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be Stream for this Profile (Business
                        Profile 1.4, Clause 3(18), Rule 2428-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(18), Rule 2430-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M177"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'AdvertismentSupportedModel']][Usage/UseType[text() = 'Stream']]"
            priority="1000"
            mode="M178">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(18), Rule 2431-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be SubscriptionModel for
                        this Profile (Business Profile 1.4, Clause 3(19), Rule 2432-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be Stream for this Profile (Business
                        Profile 1.4, Clause 3(19), Rule 2433-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(19), Rule 2435-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M182"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'SubscriptionModel']][Usage/UseType[text() = 'Stream']]"
            priority="1000"
            mode="M183">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(19), Rule 2436-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The CommercialModelType should be PayAsyouGoModel for
                        this Profile (Business Profile 1.4, Clause 3(20), Rule 2437-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The UseType should be Stream for this Profile (Business
                        Profile 1.4, Clause 3(20), Rule 2438-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template
        ...
        <xsl:if test="DealList/ReleaseDeal/Deal/DealTerms/Usage/DistributionChannelType">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: The DistributionChannelType should not used for this Profile
                    (Business Profile 1.4, Clause 3(20), Rule 2440-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M187"/>
    ...
    <!--RULE -->
    <xsl:template
            match="*:NewReleaseMessage/DealList/ReleaseDeal/Deal/DealTerms[CommercialModelType[text() = 'PayAsYouGoModel']][Usage/UseType[text() = 'Stream']]"
            priority="1000"
            mode="M188">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: The BusinessProfileVersionId should contain
                        ...
                        categories (Business Profile 1.4, Clause 3(20), Rule 2441-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
