...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--SCHEMATRON PATTERNS-->
    <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Release Profile for TV Series (version 1.4) for
        the
        NewReleaseMessage.
    </svrl:text>
        ...
        <xsl:if test="MidiDetailsByTerritory/RemasteredDate">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Information: #TV
                    Series) No deprecated date elements should be used.
                </svrl:text>
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &lt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    Profile 1.4, Clause 3.3.1(1), Rule 1773-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="count(Release[@IsMainRelease = 'true']) &gt; 1">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    Profile 1.4, Clause 3.3.1(1), Rule 1773-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M11"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber">
                    ...
                    <svrl:text>Fatal Error: #TV Series) Track bundle
                        ...
                        3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 1774-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber &gt; '1'] and not(descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource'] and SequenceNumber = '1'])">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #TV Series) All Primary Resources should be sequenced in
                    ...
                    next track bundle) (Release Profile 1.4, Clause 3.3.1(3), Rule 1776-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M14"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@ReleaseResourceType">
                    ...
                    <svrl:text>Fatal Error: #TV Series) For each
                        ...
                        Clause 4.3(1)+4.3(2), Rule 1780-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV Series) A Single ReferenceTitle must be provided for
                        each SoundRecording (Release Profile 1.4, Clause 4.3(4), Rule 1782-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV Series) At least one Title of type DisplayTitle
                        ...
                        Profile 1.4, Clause 4.3(4), Rule 1784-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #TV Series) If more than one LabelName is provided, exactly one shall be a
                        DisplayLabelName (Release Profile 1.4, Clause 4.3(6), Rule 1787-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #TV Series) The
                        ...
                        (Release Profile 1.4, Clause 4.3(6b), Rule 1789-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Error: #TV Series) The appropriate ParentalWarningType shall be provided
                        (Release Profile 1.4, Clause 4.3(8), Rule 1791-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Error: #TV Series) A ResourceReleaseDate or an
                        ...
                        the Message Sender (Release Profile 1.4, Clause 4.3(10), Rule 1793-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="*/*/DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="*/*/DisplayArtistName">
                ...
                <svrl:text>Error: #TV Series) The
                    ...
                    Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 1797-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M34"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Conditional Fatal Error: #TV Series)
                        ...
                        Profile 1.4, Clause 4.3(21), Rule 1798-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="sum(//RightShare/RightSharePercentage) &gt; 100">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal
                    ...
                    exceed 100% (Release Profile 1.4, Clause 4.3(22), Rule 1799-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M36"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV Series) A RightSharePercentage has a value between 0
                        and 100 (Release Profile 1.4, Clause 4.3(22), Rule 1800-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'TIS' and number() != .">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #TV Series) A TerritoryCode of type 'TIS' must be a
                    numeric code (Release Profile 1.4, Clause 4.3(25), Rule 1803-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        ...
        <xsl:if test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #TV Series) A deprecated TerritoryCode must be a
                    four-letter code (Release Profile 1.4, Clause 4.3(25), Rule 1803-3).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M40"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV
                        ...
                        [0-9]{15}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1805-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1807-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1808-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1809-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1810-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1813-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV
                        ...
                        Profile 1.4, Clause 4.3(30), Rule 1814-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error:
                        ...
                        (Release Profile 1.4, Clause 4.3(30), Rule 1815-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="//Comment">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Comment">
                ...
                <svrl:text>Error: #TV Series) No Comment shall be provided
                    (Release Profile 1.4, Clause 4.3(32), Rule 1817-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M54"/>
        ...
        <xsl:if test="@SequenceNumber=following-sibling::*[name()=name(current())]/@SequenceNumber">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Fatal Error: #TV Series) SequenceNumbers must all be different
                    (Release Profile 1.4, Clause 4.3(35), Rule 1820-2).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M57"/>
        ...
        <xsl:if test="ReleaseDetailsByTerritory/DisplayArtistName = ReleaseResourceReferenceList/descendant::DisplayArtistName">
            <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                ...
                <svrl:text>Error: #TV Series) DisplayArtistNames for Release and Resource must be
                    different (Release Profile 1.4, Clause 4.3(16a), Rule 1829-1).
                </svrl:text>
            </svrl:successful-report>
        </xsl:if>
        <xsl:apply-templates select="*" mode="M66"/>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Fatal Error: #TV Series) Secondary Resources shall be identified by a
                        ProprietaryId (Release Profile 1.4, Clause 4.16(6), Rule 1832-1).
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
