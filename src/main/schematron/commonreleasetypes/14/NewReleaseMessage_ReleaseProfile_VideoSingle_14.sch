...
<s:schema xmlns:s="http://purl.oclc.org/dsdl/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema">
   <!--
          ...
          rule to use XPath2 in any other way.
                    -->
   <s:title>Schematron Release Profile for Video Single (version 1.4) for the
   ...
   <s:pattern id="MultiProfile_DeprecatedDatesMustNotBeUsed">
      <s:rule context="*:NewReleaseMessage">
         <s:report test="MidiDetailsByTerritory/RemasteredDate" role="Information">Information:
            #Video Single) No deprecated date elements should be used.</s:report>
         <s:report test="MIDI/MasteredDate" role="Information">Information: #Video Single) No
         ...
         <s:report test="ReleaseDetailsByTerritory/OriginalDigitalReleaseDate" role="Information"
            >Information: #Video Single) No deprecated date elements should be used.</s:report>
         <s:report test="Release/GlobalReleaseDate" role="Information">Information: #Video Single)
         ...
         <s:report test="SoundRecordingDetailsByTerritory/RemasteredDate" role="Information"
            >Information: #Video Single) No deprecated date elements should be used.</s:report>
         <s:report test="MIDI/RemasteredDate" role="Information">Information: #Video Single) No
            deprecated date elements should be used.</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_MessageSchemaVersionId">
      <s:rule context="*:NewReleaseMessage">
         <s:assert
            ...
            role="Information">Information: #Video Single) The MessageSchemaVersionId should be at
            least 3.9.</s:assert>
   ...
   <s:pattern id="MultiProfile_MustNotContainSixResourceGroups">
      <s:rule
         ...
         <s:report test="ResourceGroup" role="Information">Information: #Video Single) There should
   ...
   <s:pattern id="MultiProfile_SoundRecordingMustNotHaveDeprecatedFlags">
      <s:rule context="*:NewReleaseMessage/ResourceList/SoundRecording">
         <s:report test="IsHiddenResource" role="Information">Information: #Video Single) No
            deprecated Flags (IsHiddenResource) must be provided for SoundRecordings.</s:report>
         <s:report test="IsBonusResource" role="Information">Information: #Video Single) No
   ...
   <s:pattern id="MultiProfile_MustContainComponentRelease">
      <s:rule
         ...
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) One component release should be supplied
   ...
   <s:pattern id="MultiProfile_MainReleaseMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:report test="count(Release[@IsMainRelease = 'true']) &lt; 1" role="Fatal Error">Fatal
            ...
            Profile 1.4, Clause 3.3.1(1), Rule 1228-1).</s:report>
         <s:report test="count(Release[@IsMainRelease = 'true']) &gt; 1" role="Fatal Error">Fatal
            Error: #Video Single) More than one Release with IsMainRelease has been specified
            (Release Profile 1.4, Clause 3.3.1(1), Rule 1228-2).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_PrimaryResourcesMustBeSequenced">
      <s:rule
         ...
         <s:assert test="SequenceNumber" role="Fatal Error">Fatal Error: #Video Single) Track bundle
            resource groups should be sequenced (Release Profile 1.4, Clause
            3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 1229-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ResourceGroupsMustBeSequenced">
      <s:rule
         ...
         <s:assert test="SequenceNumber" role="Fatal Error">Fatal Error: #Video Single) All
   ...
   <s:pattern id="MultiProfile_PrimaryResourcesMustBeSequencedWithinTheirGroup">
      <s:rule
         ...
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Video Single) All Primary Resources should be sequenced
            in the context of their track bundle ResourceGroup (i.e. the sequence restarts with the
            next track bundle) (Release Profile 1.4, Clause 3.3.1(3), Rule 1231-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SecondaryResourcesMustNotBeSequenced">
      <s:rule
         ...
         <s:report test="SequenceNumber" role="Error">Error: #Video Single) Secondary Resources
            (e.g. cover images) content items shall not be sequenced (Release Profile 1.4, Clause
            3.3.1(4), Rule 1233-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_PrimarySoundRecordingMustHaveIndirectSoundRecordingId">
      <s:rule
         ...
         <s:assert test="//ResourceReference[text() = current()]/../IndirectSoundRecordingId"
            role="Conditional Fatal Error">Conditional Fatal Error: #Video Single) Primary
            SoundRecording Resources shall have an IndirectSoundRecordingId (Release Profile 1.4,
            Clause 3.3.1(6), Rule 1234-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SoundRecordingMustHaveReferenceTitle">
      <s:rule context="*:NewReleaseMessage/ResourceList/SoundRecording">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) A Single ReferenceTitle must be provided
            for each SoundRecording (Release Profile 1.4, Clause 4.3(4), Rule 1237-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SingleFormalTitlePerTerritory">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) At least one Title of type FormalTitle
            shall be provided for the default Worldwide ReleaseDetailsByTerritory section (Release
            Profile 1.4, Clause 4.3(4), Rule 1238-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SingleDisplayTitlePerTerritory">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) At least one Title of type DisplayTitle
            shall be provided for the default Worldwide ReleaseDetailsByTerritory section (Release
            Profile 1.4, Clause 4.3(4), Rule 1239-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_DisplayLabelMustBeProvided">
      <s:rule
         ...
         <s:assert test="count(LabelName[@LabelNameType='DisplayLabelName']) = 1" role="Error"
            >Error: #Video Single) If more than one LabelName is provided, exactly one shall be a
            DisplayLabelName (Release Profile 1.4, Clause 4.3(6), Rule 1242-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_LabelNameMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:report
            ...
            role="Error">Error: #Video Single) If a LabelName is not specified for the Worldwide
   ...
   <s:pattern id="MultiProfile_GenreMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Video Single) If a Genre is not specified for the
   ...
   <s:pattern id="MultiProfile_ParentalWarningTypeMustBeProvided">
      <s:rule context="*:NewReleaseMessage">
         <s:assert test="//ParentalWarningType[string-length(normalize-space(text())) &gt; 0]"
            role="Error">Error: #Video Single) The appropriate ParentalWarningType shall be provided
            (Release Profile 1.4, Clause 4.3(8), Rule 1246-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ReleaseDateMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:assert test="ReleaseDetailsByTerritory/ReleaseDate | GlobalReleaseDate"
            role="Conditional Error">Conditional Error: #Video Single) A GlobalReleaseDate or a
            ReleaseDate shall be provided for each Release (Release Profile 1.4, Clause 4.3(9),
            Rule 1247-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ResourceReleaseDateMustBeProvided">
      <s:rule
         ...
         <s:assert
            ...
            role="Conditional Error">Conditional Error: #Video Single) A ResourceReleaseDate or an
            OriginalResourceReleaseDate shall be provided for each primary Resource if available to
            the Message Sender (Release Profile 1.4, Clause 4.3(10), Rule 1248-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_MusicalWorkContributorRole">
      <s:rule context="//MusicalWork">
         <s:assert
            ...
            role="Conditional Error">Conditional Error: #Video Single) If there is a MusicalWork,
   ...
   <s:pattern id="MultiProfile_ResourceContributorDuplicate">
      <s:rule context="*:NewReleaseMessage/ResourceList/*/*">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) ResourceContributors shall be provided
   ...
   <s:pattern id="MultiProfile_DisplayArtistNameDuplicate">
      <s:rule context="*:NewReleaseMessage/ResourceList">
         <s:report test="*/*/DisplayArtistName" role="Error">Error: #Video Single) The
            DisplayArtistNames of a Resource shall not be the same as the DisplayArtistName of the
            Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 1252-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_IndirectResourceContributorDuplicate">
      <s:rule context="*:NewReleaseMessage/ResourceList/*/*">
         <s:assert
            ...
            role="Conditional Fatal Error">Conditional Fatal Error: #Video Single)
            IndirectResourceContributors shall be provided only once (with multiple roles) (Release
            Profile 1.4, Clause 4.3(21), Rule 1253-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_RightSharePercentage">
      <s:rule context="//MusicalWork">
         <s:report test="sum(//RightShare/RightSharePercentage) &gt; 100" role="Fatal Error">Fatal
            ...
            not exceed 100% (Release Profile 1.4, Clause 4.3(22), Rule 1254-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_RightSharePercentageValue">
      <s:rule context="//RightSharePercentage">
         <s:assert test="//RightSharePercentage &gt; 0 and //RightSharePercentage &lt; 100"
            role="Fatal Error">Fatal Error: #Video Single) A RightSharePercentage has a value
            between 0 and 100 (Release Profile 1.4, Clause 4.3(22), Rule 1255-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_FlagsOnlyOnContentItems">
      <s:rule context="*:NewReleaseMessage">
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Video Single) IsHiddenResource must not be used on a
         ...
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Video Single) IsBonusResource must not be used on a
            Resource (Release Profile 1.4, Clause 4.3(24)+4.10(7g)+4.10(7h), Rule
            1257-2).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_Territory">
      <s:rule context="//TerritoryCode | //ExcludedTerritoryCode">
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Video Single) A TerritoryCode of type 'ISO' must be a
         ...
         <s:report test="substring(@IdentifierType, 1, 3) = 'TIS' and number() != ."
            role="Fatal Error">Fatal Error: #Video Single) A TerritoryCode of type 'TIS' must be a
            numeric code (Release Profile 1.4, Clause 4.3(25), Rule 1258-2).</s:report>
         <s:report
            test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)"
            role="Fatal Error">Fatal Error: #Video Single) A deprecated TerritoryCode must be a
            four-letter code (Release Profile 1.4, Clause 4.3(25), Rule 1258-3).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_TerritoryTIS">
      <s:rule context="//TerritoryCode | //ExcludedTerritoryCode">
         <s:report test="substring(@IdentifierType, 1, 3) = 'TIS'" role="Fatal Error">Fatal Error:
            ...
            Clause 4.3(25), Rule 1259-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISNI">
      <s:rule context="//PartyId[@IsISNI = 'true']">
         <s:assert test="matches(., '^[0-9]{15}[X0-9]$')" role="Fatal Error">Fatal Error: #Video
            ...
            [0-9]{15}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1260-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISRC">
      <s:rule context="//ISRC">
         ...
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) An ISRC must be a string starting with an
   ...
   <s:pattern id="MultiProfile_GRid">
      <s:rule context="//GRid">
         <s:assert test="matches(., '^[a-zA-Z0-9]{18}$')" role="Fatal Error">Fatal Error: #Video
            ...
            Profile 1.4, Clause 4.3(30), Rule 1262-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISSN">
      <s:rule context="//ISSN">
         <s:assert test="matches(., '^[0-9]{4}-[0-9]{3}[X0-9]$')" role="Fatal Error">Fatal Error:
            ...
            [0-9]{4}-[0-9]{3}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 1264-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISBN">
      <s:rule context="//ISBN">
         <s:assert test="matches(., '^97[8-9][0-9]{9}[X0-9]$')" role="Fatal Error">Fatal Error:
            ...
            (Release Profile 1.4, Clause 4.3(30), Rule 1265-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_VISAN">
      <s:rule context="//VISAN">
         <s:assert test="matches(., '^[A-F0-9]{24}$')" role="Fatal Error">Fatal Error: #Video
            Single) A VISAN must be a string conforming to the pattern [A-F0-9]{24} (Release Profile
            1.4, Clause 4.3(30), Rule 1266-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_ISAN">
      <s:rule context="//ISAN">
         <s:assert test="matches(., '^[A-F0-9]{12}$')" role="Fatal Error">Fatal Error: #Video
            Single) An ISAN must be a string conforming to the pattern [A-F0-9]{12} (Release Profile
            1.4, Clause 4.3(30), Rule 1267-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISMN">
      <s:rule context="//ISMN">
         <s:assert test="matches(., '^979[0-9]{9}[X0-9]$')" role="Fatal Error">Fatal Error: #Video
            ...
            Profile 1.4, Clause 4.3(30), Rule 1268-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISWC">
      <s:rule context="//ISWC">
         <s:assert test="matches(., '^[a-zA-Z][0-9]{10}$')" role="Fatal Error">Fatal Error: #Video
            ...
            Profile 1.4, Clause 4.3(30), Rule 1269-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ICPN">
      <s:rule context="//ICPN">
         <s:assert test="matches(., '^[0-9]{8}$|^[0-9]{12,14}$')" role="Fatal Error">Fatal Error:
            ...
            [0-9]{12,14} (Release Profile 1.4, Clause 4.3(30), Rule 1270-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_UserDefinedValue">
      <s:rule context="//*[(name() != 'LabelName') and @UserDefinedValue]">
         <s:assert test=".='UserDefined'" role="Fatal Error">Fatal Error: #Video Single) The value
            shall be 'UserDefined' if a user-defined value is supplied (Release Profile 1.4,
            Clause 4.3(31), Rule 1271-1).</s:assert>
         <s:assert test="@Namespace" role="Fatal Error">Fatal Error: #Video Single) The appropriate
            Namespace for the user-defined value shall be provided (Release Profile 1.4, Clause
            4.3(31), Rule 1271-2).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_CommentMustNotBeProvided">
      <s:rule context="*:NewReleaseMessage">
         <s:report test="//Comment" role="Error">Error: #Video Single) No Comment shall be provided
            (Release Profile 1.4, Clause 4.3(32), Rule 1272-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SequenceNumberAsAttribute">
      <s:rule context="//*[@SequenceNumber]">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) SequenceNumbers must run from 1 to the
         ...
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Video Single) SequenceNumbers must all be different
            (Release Profile 1.4, Clause 4.3(35), Rule 1275-2).</s:report>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_PercentageValue">
      <s:rule context="//*[@HasMaxValueOfOne = 'true']">
         <s:report test="number(.) &gt; 1" role="Fatal Error">Fatal Error: #Video Single) A
            Percentage with HasMaxValueOfOne set to true has a value between 0 and 1 (Release
            Profile 1.4, Clause 4.3(36a), Rule 1276-1).</s:report>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_PercentageValue2">
      <s:rule context="//*[@HasMaxValueOfOne = 'false']">
         <s:report test="number(.) &lt;= 1" role="Information">Information: #Video Single)
   ...
   <s:pattern id="MultiProfile_RightSharePercentageValue2">
      <s:rule context="//RightSharePercentage[not(@HasMaxValueOfOne)]">
         <s:report test="number(.) &lt;= 1" role="Information">Information: #Video Single)
            Percentages are typically provided in the interval between 0 and 100. The value provided
            seems to indicate a value equal to, or less than, 1% (Release Profile 1.4, Clause
            4.3(36b), Rule 1278-1).</s:report>
      </s:rule>
   </s:pattern>

   <s:pattern id="VideoSingle_ReleaseProfileVersionId">
      <s:rule context="*:NewReleaseMessage">
         <s:assert test="@ReleaseProfileVersionId = 'CommonReleaseTypes/14/VideoSingle'"
            role="Fatal Error">Fatal Error: #Video Single) The ReleaseProfileVersionId should be
   ...
   <s:pattern id="MultiProfile_MustContainTwoReleases">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:assert test="count(Release) &gt;= 2" role="Fatal Error">Fatal Error: #Video Single) A
            Release of this type must contain at least two releases. (Release Profile 1.4, Clause
            3.1, Rule 1281-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_MustContainVideoScreenCapture">
      <s:rule context="*:NewReleaseMessage/ResourceList">
         <s:assert test="Image/ImageType[text() = 'VideoScreenCapture']" role="Fatal Error">Fatal
            ...
            VideoScreenCapture (Release Profile 1.4, Clause 3.1, Rule 1282-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_MustContainShortFormMusicalWorkVideo">
      <s:rule context="*:NewReleaseMessage/ResourceList">
         <s:assert test="Video/VideoType[text() = 'ShortFormMusicalWorkVideo']" role="Fatal Error"
            >Fatal Error: #Video Single) A Release of this type must contain at least one Video of
   ...
   <s:pattern id="MultiProfile_MustContainMultipleReleases">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) A Release of this type must contain
            multiple releases (a Single and a TrackRelease for every resource marked as primary)
            (Release Profile 1.4, Clause 3.1, Rule 1285-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_MustContainVideo">
      <s:rule context="*:NewReleaseMessage/ResourceList">
         <s:assert test="Video" role="Fatal Error">Fatal Error: #Video Single) A Release of this
   ...
   <s:pattern id="MultiProfile_MustContainTrackRelease">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:assert test="Release/ReleaseType[text() = 'TrackRelease']" role="Fatal Error">Fatal
            ...
            (Release Profile 1.4, Clause 3.1, Rule 1287-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_DisplayArtistMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:assert test="ReleaseDetailsByTerritory/DisplayArtist" role="Fatal Error">Fatal Error:
            ...
            Clause 4.3(12c)+4.3(15b), Rule 1288-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_DisplayArtistNamesMustBeDifferent">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:report
            ...
            role="Error">Error: #Video Single) DisplayArtistNames for Release and Resource must be
            different (Release Profile 1.4, Clause 4.3(16a), Rule 1289-1).</s:report>
      </s:rule>
   </s:pattern>

   <s:pattern id="VideoSingle_MustContainVideoSingleRelease">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:assert test="Release/ReleaseType[text() = 'VideoSingle']" role="Fatal Error">Fatal
            Error: #Video Single) A Video Single must contain one VideoSingle release (Release
            Profile 1.4, Clause 4.14(3), Rule 1290-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_MainReleaseMustHaveGridOrICPN">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) The MainRelease shall be identified by
            either a GRid or by an ICPN (Release Profile 1.4, Clause 4.14(4), Rule
            1291-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="VideoSingle_PrimaryVideoMustHaveISRC">
      <s:rule
         ...
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) Primary Video Resources should be
            identified with an ISRC (Release Profile 1.4, Clause 4.14(5), Rule 1292-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_PrimarySoundRecordingMustHaveISRC">
      <s:rule
         ...
         <s:assert
            test="//ResourceReference[text() = current()]/../*/ISRC[string-length(normalize-space(text())) &gt; 0]"
            role="Fatal Error">Fatal Error: #Video Single) Primary SoundRecording Resources shall be
            identified with an ISRC (Release Profile 1.4, Clause 4.14(5), Rule 1293-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SecondaryResourceMustHaveProprietaryId">
      <s:rule
         ...
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Video Single) Secondary Resources shall be identified
            by a ProprietaryId (Release Profile 1.4, Clause 4.14(6), Rule 1294-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_LabelNameMustBeProvided2">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:assert test="ReleaseDetailsByTerritory/LabelName" role="Fatal Error">Fatal Error: #Video
            ...
            4.14(9), Rule 1295-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="VideoSingle_MayContainRelatedReleaseOfTypeIsEquivalentToAudio">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:assert
            test="descendant::RelatedRelease[ReleaseRelationshipType = 'IsEquivalentToAudio']"
            role="Error">Error: #Video Single) A Video Single may contain a RelatedRelease of type
            IsEquivalentToAudio (Release Profile 1.4, Clause 4.14(10), Rule 1296-1).</s:assert>
      </s:rule>
   </s:pattern>
</s:schema>
