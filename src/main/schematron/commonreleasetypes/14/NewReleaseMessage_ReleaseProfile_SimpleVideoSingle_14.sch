...
<s:schema xmlns:s="http://purl.oclc.org/dsdl/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema">
   <!--
          ...
          rule to use XPath2 in any other way.
                    -->
   <s:title>Schematron Release Profile for Simple Video Single (version 1.4) for the
   ...
   <s:pattern id="MultiProfile_DeprecatedDatesMustNotBeUsed">
      <s:rule context="*:NewReleaseMessage">
         <s:report test="MidiDetailsByTerritory/RemasteredDate" role="Information">Information:
            #Simple Video Single) No deprecated date elements should be used.</s:report>
         <s:report test="MIDI/MasteredDate" role="Information">Information: #Simple Video Single) No
         ...
         <s:report test="ReleaseDetailsByTerritory/OriginalDigitalReleaseDate" role="Information"
            >Information: #Simple Video Single) No deprecated date elements should be
            used.</s:report>
         <s:report test="Release/GlobalReleaseDate" role="Information">Information: #Simple Video
            Single) No deprecated date elements should be used.</s:report>
         <s:report test="Release/GlobalOriginalReleaseDate" role="Information">Information: #Simple
         ...
         <s:report test="SoundRecordingDetailsByTerritory/RemasteredDate" role="Information"
            >Information: #Simple Video Single) No deprecated date elements should be
            used.</s:report>
         <s:report test="MIDI/RemasteredDate" role="Information">Information: #Simple Video Single)
   ...
   <s:pattern id="MultiProfile_MessageSchemaVersionId">
      <s:rule context="*:NewReleaseMessage">
         <s:assert
            ...
            role="Information">Information: #Simple Video Single) The MessageSchemaVersionId should
   ...
   <s:pattern id="MultiProfile_MustNotContainSixResourceGroups">
      <s:rule
         ...
         <s:report test="ResourceGroup" role="Information">Information: #Simple Video Single) There
   ...
   <s:pattern id="MultiProfile_SoundRecordingMustNotHaveDeprecatedFlags">
      <s:rule context="*:NewReleaseMessage/ResourceList/SoundRecording">
         <s:report test="IsHiddenResource" role="Information">Information: #Simple Video Single) No
            deprecated Flags (IsHiddenResource) must be provided for SoundRecordings.</s:report>
         <s:report test="IsBonusResource" role="Information">Information: #Simple Video Single) No
   ...
   <s:pattern id="MultiProfile_MustContainComponentRelease">
      <s:rule
         ...
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) One component release should be
   ...
   <s:pattern id="MultiProfile_MainReleaseMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:report test="count(Release[@IsMainRelease = 'true']) &lt; 1" role="Fatal Error">Fatal
            ...
            (Release Profile 1.4, Clause 3.3.1(1), Rule 1973-1).</s:report>
         <s:report test="count(Release[@IsMainRelease = 'true']) &gt; 1" role="Fatal Error">Fatal
            Error: #Simple Video Single) More than one Release with IsMainRelease has been specified
            (Release Profile 1.4, Clause 3.3.1(1), Rule 1973-2).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_PrimaryResourcesMustBeSequenced">
      <s:rule
         ...
         <s:assert test="SequenceNumber" role="Fatal Error">Fatal Error: #Simple Video Single) Track
            bundle resource groups should be sequenced (Release Profile 1.4, Clause
            3.3.1(2)+3.3.1(3)+3.3.1(5), Rule 1974-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ResourceGroupsMustBeSequenced">
      <s:rule
         ...
         <s:assert test="SequenceNumber" role="Fatal Error">Fatal Error: #Simple Video Single) All
   ...
   <s:pattern id="MultiProfile_PrimaryResourcesMustBeSequencedWithinTheirGroup">
      <s:rule
         ...
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) All Primary Resources should be
   ...
   <s:pattern id="MultiProfile_SecondaryResourcesMustNotBeSequenced">
      <s:rule
         ...
         <s:report test="SequenceNumber" role="Error">Error: #Simple Video Single) Secondary
            Resources (e.g. cover images) content items shall not be sequenced (Release Profile 1.4,
            Clause 3.3.1(4), Rule 1978-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_PrimarySoundRecordingMustHaveIndirectSoundRecordingId">
      <s:rule
         ...
         <s:assert test="//ResourceReference[text() = current()]/../IndirectSoundRecordingId"
            role="Conditional Fatal Error">Conditional Fatal Error: #Simple Video Single) Primary
            SoundRecording Resources shall have an IndirectSoundRecordingId (Release Profile 1.4,
            Clause 3.3.1(6), Rule 1979-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SoundRecordingMustHaveReferenceTitle">
      <s:rule context="*:NewReleaseMessage/ResourceList/SoundRecording">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) A Single ReferenceTitle must be
   ...
   <s:pattern id="MultiProfile_SingleFormalTitlePerTerritory">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) At least one Title of type
            FormalTitle shall be provided for the default Worldwide ReleaseDetailsByTerritory
            section (Release Profile 1.4, Clause 4.3(4), Rule 1983-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SingleDisplayTitlePerTerritory">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]">
         <s:assert
            ...
            section (Release Profile 1.4, Clause 4.3(4), Rule 1984-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_DisplayLabelMustBeProvided">
      <s:rule
         ...
         <s:assert test="count(LabelName[@LabelNameType='DisplayLabelName']) = 1" role="Error"
            >Error: #Simple Video Single) If more than one LabelName is provided, exactly one shall
            be a DisplayLabelName (Release Profile 1.4, Clause 4.3(6), Rule 1987-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_LabelNameMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:report
            ...
            role="Error">Error: #Simple Video Single) If a LabelName is not specified for the
   ...
   <s:pattern id="MultiProfile_UserDefinedLabelNameType">
      <s:rule context="//LabelName[@UserDefinedValue]">
         <s:assert test="@LabelNameType='UserDefined'" role="Error">Error: #Simple Video Single) The
            LabelNameType shall be 'UserDefined' if a user-defined value is supplied for a LabelName
            (Release Profile 1.4, Clause 4.3(6b), Rule 1989-1).</s:assert>
         <s:assert test="@Namespace" role="Error">Error: #Simple Video Single) The appropriate
            Namespace for the user-defined value shall be provided (Release Profile 1.4, Clause
            4.3(6b), Rule 1989-2).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_GenreMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) If a Genre is not specified for
   ...
   <s:pattern id="MultiProfile_ParentalWarningTypeMustBeProvided">
      <s:rule context="*:NewReleaseMessage">
         <s:assert test="//ParentalWarningType[string-length(normalize-space(text())) &gt; 0]"
            role="Error">Error: #Simple Video Single) The appropriate ParentalWarningType shall be
            provided (Release Profile 1.4, Clause 4.3(8), Rule 1991-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ReleaseDateMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:assert test="ReleaseDetailsByTerritory/ReleaseDate | GlobalReleaseDate"
            role="Conditional Error">Conditional Error: #Simple Video Single) A GlobalReleaseDate or
            a ReleaseDate shall be provided for each Release (Release Profile 1.4, Clause 4.3(9),
            Rule 1992-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ResourceReleaseDateMustBeProvided">
      <s:rule
         ...
         <s:assert
            ...
            role="Conditional Error">Conditional Error: #Simple Video Single) A ResourceReleaseDate
   ...
   <s:pattern id="MultiProfile_MusicalWorkContributorRole">
      <s:rule context="//MusicalWork">
         <s:assert
            ...
            role="Conditional Error">Conditional Error: #Simple Video Single) If there is a
            MusicalWork, there has to be a creative contributor (Release Profile 1.4, Clause
            4.3(12a), Rule 1994-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ResourceContributorDuplicate">
      <s:rule context="*:NewReleaseMessage/ResourceList/*/*">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) ResourceContributors shall be
            provided only once (with multiple roles) (Release Profile 1.4, Clause 4.3(13)+4.3(20),
            Rule 1996-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_DisplayArtistNameDuplicate">
      <s:rule context="*:NewReleaseMessage/ResourceList">
         <s:report test="*/*/DisplayArtistName" role="Error">Error: #Simple Video Single) The
            DisplayArtistNames of a Resource shall not be the same as the DisplayArtistName of the
            Album it belongs to (Release Profile 1.4, Clause 4.3(18), Rule 1997-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_IndirectResourceContributorDuplicate">
      <s:rule context="*:NewReleaseMessage/ResourceList/*/*">
         <s:assert
            ...
            role="Conditional Fatal Error">Conditional Fatal Error: #Simple Video Single)
            IndirectResourceContributors shall be provided only once (with multiple roles) (Release
            Profile 1.4, Clause 4.3(21), Rule 1998-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_RightSharePercentage">
      <s:rule context="//MusicalWork">
         <s:report test="sum(//RightShare/RightSharePercentage) &gt; 100" role="Fatal Error">Fatal
            ...
            must not exceed 100% (Release Profile 1.4, Clause 4.3(22), Rule 1999-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_RightSharePercentageValue">
      <s:rule context="//RightSharePercentage">
         <s:assert test="//RightSharePercentage &gt; 0 and //RightSharePercentage &lt; 100"
            role="Fatal Error">Fatal Error: #Simple Video Single) A RightSharePercentage has a value
            between 0 and 100 (Release Profile 1.4, Clause 4.3(22), Rule 2000-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_FlagsOnlyOnContentItems">
      <s:rule context="*:NewReleaseMessage">
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) IsHiddenResource must not be used
         ...
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) IsBonusResource must not be used
            on a Resource (Release Profile 1.4, Clause 4.3(24)+4.10(7g)+4.10(7h), Rule
            2002-2).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_Territory">
      <s:rule context="//TerritoryCode | //ExcludedTerritoryCode">
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) A TerritoryCode of type 'ISO' must
         ...
         <s:report test="substring(@IdentifierType, 1, 3) = 'TIS' and number() != ."
            role="Fatal Error">Fatal Error: #Simple Video Single) A TerritoryCode of type 'TIS' must
            be a numeric code (Release Profile 1.4, Clause 4.3(25), Rule 2003-2).</s:report>
         <s:report
            test="substring(@IdentifierType, 1, 3) = 'Dep' and (string-length(normalize-space(text())) != 4 or number() = .)"
            role="Fatal Error">Fatal Error: #Simple Video Single) A deprecated TerritoryCode must be
            a four-letter code (Release Profile 1.4, Clause 4.3(25), Rule 2003-3).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_TerritoryTIS">
      <s:rule context="//TerritoryCode | //ExcludedTerritoryCode">
         <s:report test="substring(@IdentifierType, 1, 3) = 'TIS'" role="Fatal Error">Fatal Error:
            ...
            1.4, Clause 4.3(25), Rule 2004-1).</s:report>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_ISNI">
      <s:rule context="//PartyId[@IsISNI = 'true']">
         <s:assert test="matches(., '^[0-9]{15}[X0-9]$')" role="Fatal Error">Fatal Error: #Simple
            Video Single) A PartyId of type 'ISNI' must be a string conforming to the pattern
            [0-9]{15}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 2005-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISRC">
      <s:rule context="//ISRC">
         ...
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) An ISRC must be a string starting
            with an ISO 3166 code or FX, QM, UK, CP, DG or ZZ (Release Profile 1.4, Clause 4.3(30),
            Rule 2006-2).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_GRid">
      <s:rule context="//GRid">
         <s:assert test="matches(., '^[a-zA-Z0-9]{18}$')" role="Fatal Error">Fatal Error: #Simple
            Video Single) A GRid must be a string conforming to the pattern [a-zA-Z0-9]{18} (Release
            Profile 1.4, Clause 4.3(30), Rule 2007-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SICI">
      <s:rule context="//SICI">
         <s:assert test="matches(., '^[0-9]{4}-[0-9]{3}[X0-9].+')" role="Fatal Error">Fatal Error:
            ...
            [0-9]{4}-[0-9]{3}[X0-9].+ (Release Profile 1.4, Clause 4.3(30), Rule 2008-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISSN">
      <s:rule context="//ISSN">
         <s:assert test="matches(., '^[0-9]{4}-[0-9]{3}[X0-9]$')" role="Fatal Error">Fatal Error:
            ...
            [0-9]{4}-[0-9]{3}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 2009-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ISBN">
      <s:rule context="//ISBN">
         <s:assert test="matches(., '^97[8-9][0-9]{9}[X0-9]$')" role="Fatal Error">Fatal Error:
            ...
            97[8-9][0-9]{9}[X0-9] (Release Profile 1.4, Clause 4.3(30), Rule 2010-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_VISAN">
      <s:rule context="//VISAN">
         <s:assert test="matches(., '^[A-F0-9]{24}$')" role="Fatal Error">Fatal Error: #Simple Video
            Single) A VISAN must be a string conforming to the pattern [A-F0-9]{24} (Release Profile
            1.4, Clause 4.3(30), Rule 2011-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_ISAN">
      <s:rule context="//ISAN">
         <s:assert test="matches(., '^[A-F0-9]{12}$')" role="Fatal Error">Fatal Error: #Simple Video
            Single) An ISAN must be a string conforming to the pattern [A-F0-9]{12} (Release Profile
            1.4, Clause 4.3(30), Rule 2012-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_ISMN">
      <s:rule context="//ISMN">
         <s:assert test="matches(., '^979[0-9]{9}[X0-9]$')" role="Fatal Error">Fatal Error: #Simple
            Video Single) An ISMN must be a string conforming to the pattern 979[0-9]{9}[X0-9]
            (Release Profile 1.4, Clause 4.3(30), Rule 2013-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_ISWC">
      <s:rule context="//ISWC">
         <s:assert test="matches(., '^[a-zA-Z][0-9]{10}$')" role="Fatal Error">Fatal Error: #Simple
            Video Single) An ISWC must be a string conforming to the pattern [a-zA-Z][0-9]{10}
            (Release Profile 1.4, Clause 4.3(30), Rule 2014-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_ICPN">
      <s:rule context="//ICPN">
         <s:assert test="matches(., '^[0-9]{8}$|^[0-9]{12,14}$')" role="Fatal Error">Fatal Error:
            ...
            [0-9]{12,14} (Release Profile 1.4, Clause 4.3(30), Rule 2015-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_UserDefinedValue">
      <s:rule context="//*[(name() != 'LabelName') and @UserDefinedValue]">
         <s:assert test=".='UserDefined'" role="Fatal Error">Fatal Error: #Simple Video Single) The
            value shall be 'UserDefined' if a user-defined value is supplied (Release Profile 1.4,
            Clause 4.3(31), Rule 2016-1).</s:assert>
         <s:assert test="@Namespace" role="Fatal Error">Fatal Error: #Simple Video Single) The
            appropriate Namespace for the user-defined value shall be provided (Release Profile 1.4,
            Clause 4.3(31), Rule 2016-2).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_CommentMustNotBeProvided">
      <s:rule context="*:NewReleaseMessage">
         <s:report test="//Comment" role="Error">Error: #Simple Video Single) No Comment shall be
            provided (Release Profile 1.4, Clause 4.3(32), Rule 2017-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_SequenceNumberAsAttribute">
      <s:rule context="//*[@SequenceNumber]">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) SequenceNumbers must run from 1 to
         ...
         <s:report
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) SequenceNumbers must all be
            different (Release Profile 1.4, Clause 4.3(35), Rule 2020-2).</s:report>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_PercentageValue">
      <s:rule context="//*[@HasMaxValueOfOne = 'true']">
         <s:report test="number(.) &gt; 1" role="Fatal Error">Fatal Error: #Simple Video Single) A
            Percentage with HasMaxValueOfOne set to true has a value between 0 and 1 (Release
            Profile 1.4, Clause 4.3(36a), Rule 2021-1).</s:report>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_PercentageValue2">
      <s:rule context="//*[@HasMaxValueOfOne = 'false']">
         <s:report test="number(.) &lt;= 1" role="Information">Information: #Simple Video Single)
   ...
   <s:pattern id="SimpleVideoSingle_ReleaseProfileVersionId">
      <s:rule context="*:NewReleaseMessage">
         <s:assert test="@ReleaseProfileVersionId = 'CommonReleaseTypes/14/VideoSingle'"
            role="Fatal Error">Fatal Error: #Simple Video Single) The ReleaseProfileVersionId should
   ...
   <s:pattern id="MultiProfile_MustContainShortFormMusicalWorkVideo">
      <s:rule context="*:NewReleaseMessage/ResourceList">
         <s:assert test="Video/VideoType[text() = 'ShortFormMusicalWorkVideo']" role="Fatal Error"
            >Fatal Error: #Simple Video Single) A Release of this type must contain at least one
            Video of type ShortFormMusicalWorkVideo (Release Profile 1.4, Clause 3.1, Rule
            2025-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="VideoSingle_MustContainOneVideoScreenCaptureAsSecondaryResource">
      <s:rule
         context="//ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]">
         <s:assert
            test="count(//ResourceList/Image[ImageType/text() = 'VideoScreenCapture' and ResourceReference=current()/ReleaseResourceReference]) = 1"
            role="Draft">Draft: #Simple Video Single) A Release of this type must contain exactly
            one Image of type VideoScreenCapture as a secondary Resource (Release Profile 1.4,
            Clause 3.1, Rule 2026-1).</s:assert>
      </s:rule>
   </s:pattern>

   <s:pattern id="MultiProfile_MustContainVideo">
      <s:rule context="*:NewReleaseMessage/ResourceList">
         <s:assert test="Video" role="Fatal Error">Fatal Error: #Simple Video Single) A Release of
   ...
   <s:pattern id="MultiProfile_DisplayArtistMustBeProvided">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:assert test="ReleaseDetailsByTerritory/DisplayArtist" role="Fatal Error">Fatal Error:
            ...
            Clause 4.3(12c)+4.3(15b), Rule 2028-1).</s:assert>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_DisplayArtistNamesMustBeDifferent">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:report
            ...
            role="Error">Error: #Simple Video Single) DisplayArtistNames for Release and Resource
            must be different (Release Profile 1.4, Clause 4.3(16a), Rule 2029-1).</s:report>
      </s:rule>
   </s:pattern>
   ...
   <s:pattern id="MultiProfile_MainReleaseMustHaveGridOrICPN">
      <s:rule context="*:NewReleaseMessage/ReleaseList">
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) The MainRelease shall be
   ...
   <s:pattern id="MultiProfile_PrimarySoundRecordingMustHaveISRC">
      <s:rule
         ...
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) Primary SoundRecording Resources
   ...
   <s:pattern id="MultiProfile_SecondaryResourceMustHaveProprietaryId">
      <s:rule
         ...
         <s:assert
            ...
            role="Fatal Error">Fatal Error: #Simple Video Single) Secondary Resources shall be
   ...
   <s:pattern id="MultiProfile_LabelNameMustBeProvided2">
      <s:rule context="*:NewReleaseMessage/ReleaseList/Release">
         <s:assert test="ReleaseDetailsByTerritory/LabelName" role="Fatal Error">Fatal Error:
            ...
            1.4, Clause 4.14(9), Rule 2033-1).</s:assert>
      </s:rule>
   </s:pattern>
</s:schema>
